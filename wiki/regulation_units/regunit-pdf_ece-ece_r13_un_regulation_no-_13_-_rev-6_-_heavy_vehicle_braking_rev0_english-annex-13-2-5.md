...
basis: '2.5.
  ...
  according to data provided at least by its own sensor. 1/

  1/

  Anti-lock systems with select-high control are deemed to include both directly and

  indirectly controlled wheels; in systems with select-low control, all sensed wheels
  are deemed to

  be directly controlled wheels.
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-2-5
...
status: draft
subject: null
summary: Regulation unit `annex-13-2-5` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.5.
updated: '2026-04-13'
---
...
1/
Anti-lock systems with select-high control are deemed to include both directly and
indirectly controlled wheels; in systems with select-low control, all sensed wheels are deemed to
be directly controlled wheels.
E/ECE/324
E/ECE/TRANS/505 } Rev.1/Add.12/Rev.6
Regulation No. 13
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-2-5
- source_url: n/a
- confidence: medium
