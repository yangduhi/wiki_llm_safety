...
basis: 'S4. Definitions.
  ...
  Backing event means an amount of time which starts when the vehicle''s direction
  selector is placed in reverse, and ends at the manufacturer''s choosing, when the
  vehicle forward motion reaches:'
browse_buckets: []
clause_path: s4
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-111-s4
jurisdiction: US
...
status: draft
summary: Regulation unit `s4` from xml_fmvss-571-111.
