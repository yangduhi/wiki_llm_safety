...
basis: '4.5.1.3.
  ...
  The trailer shall be loaded (as closely as possible) to the maximum technically

  permitted mass for each brake, however, additional mass may be added if

  required to ensure that sufficient mass is over the axle under test to achieve a

  braking rate of 0.55 TR/(maximum technically permitted mass per brake) without

  wheel lock.'
browse_buckets: []
clause_path: annex-19-4-5-1-3
comparison_key: 60c5bb12a398bcbef1f0779b92d75221568f4b06
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-19-4-5-1-3
...
status: draft
subject: null
summary: Regulation unit `annex-19-4-5-1-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 4.5.1.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-19-4-5-1-3
- source_url: n/a
- confidence: medium
