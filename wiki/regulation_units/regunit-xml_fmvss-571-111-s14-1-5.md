...
basis: S14.1.5 Test reference point. Obtain the test reference point using the following
  procedure.
browse_buckets: []
clause_path: s14-1-5
comparison_key: a6262862d12bd13e4664353f5090133f895136cf
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-111-s14-1-5
...
- visibility
sectno: null
source_citation: xml_fmvss-571-111 / s14-1-5
source_collection: xml_fmvss
source_url: null
statement: S14.1.5 Test reference point. Obtain the test reference point using the
  following procedure.
status: draft
subject: null
summary: Regulation unit `s14-1-5` from xml_fmvss-571-111.
title: S14.1.5 Test reference point. Obtain the test reference point using the following
  procedure.
updated: '2026-04-13'
---
