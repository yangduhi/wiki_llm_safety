...
basis: '3.5.1.1.
  ...
  This test is carried out at an initial speed equivalent to 40 km/h in the case of

  Type-I test and 60 km/h in the case of Type-III test in order to evaluate the hot

  braking performance at the end of Type-I and Type-III tests. The Type-I and/or

  Type-III fade test has/have to be done immediately after this cold performance test.'
browse_buckets: []
clause_path: annex-11-3-5-1-1
comparison_key: 5bdb5f74ab32329f67376db0f4602968abdbc0f6
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-11-3-5-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-11-3-5-1-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.5.1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-11-3-5-1-1
- source_url: n/a
- confidence: medium
