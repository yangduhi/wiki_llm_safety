...
basis: '6.1.
  ...
  Trailers equipped with anti-lock systems shall be so designed that, even after the

  service braking control device has been fully applied for some time, the vehicle

  retains sufficient energy to bring it to a halt within a reasonable distance.'
browse_buckets: []
clause_path: annex-13-6-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-6-1
...
status: draft
subject: null
summary: Regulation unit `annex-13-6-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 6.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-6-1
- source_url: n/a
- confidence: medium
