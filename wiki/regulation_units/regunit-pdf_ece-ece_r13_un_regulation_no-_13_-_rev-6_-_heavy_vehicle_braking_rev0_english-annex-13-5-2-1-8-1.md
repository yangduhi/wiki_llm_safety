...
basis: '5.2.1.8.1.
  ...
  Compensation by the electric control transmission for deterioration or defect

  within the braking system shall be indicated to the driver by means of the yellow

  warning signal specified in paragraph 5.2.1.29.1.2. This requirement shall apply

  for all conditions of loading when compensation exceeds the following limits:

  5.2.1.8.1.1.

  a difference in transverse braking pressures on any axle of:'
browse_buckets: []
clause_path: annex-13-5-2-1-8-1
comparison_key: 319c3c7d3a283ed9d2ea8ae78c80698c0dccb03a
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-5-2-1-8-1
...
status: draft
subject: null
summary: Regulation unit `annex-13-5-2-1-8-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.2.1.8.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-5-2-1-8-1
- source_url: n/a
- confidence: medium
