...
basis: 가) 부분 자율주행시스템이나 자동차에 심각한 고장이 발생한 경우
browse_buckets: []
clause_path: item-697
comparison_key: f6b30b476cfc415c25ae8b69e73d0fecd7110bd6
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-item-697
...
line_index_end: 697
line_index_start: 697
note_type: regulation_unit
page_end: null
page_start: null
parent_clause_path: 1-689
parent_clause_text: 1) 위험최소화운행이 시작되면 주행 중인 차로(차선표시가 분명하지 않은 경우
parent_title: 가) 부분 자율주행시스템이나 자동차에 심각한 고장이 발생한 경우
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / item-697
source_collection: xml_kmvss
source_url: null
statement: 가) 부분 자율주행시스템이나 자동차에 심각한 고장이 발생한 경우
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `item-697` from xml_kmvss-kmvss_att_0027_128.
title: 가) 부분 자율주행시스템이나 자동차에 심각한 고장이 발생한 경우
updated: '2026-04-13'
---

# 가) 부분 자율주행시스템이나 자동차에 심각한 고장이 발생한 경우
