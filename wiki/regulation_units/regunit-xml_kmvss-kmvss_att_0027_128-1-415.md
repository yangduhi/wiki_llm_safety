...
basis: '1) 부분 자율주행시스템은 다음 그림의 음영(陰影)으로 표시된 부분을 포함하는

  범위의 도로의 구조, 차선 및 주행 중인 다른 자동차 등 주행 환경 및 교통

  상황을 확인할 수 있는 감지기능을 갖출 것

  [부분 자율주행시스템의 감지범위]'
browse_buckets: []
clause_path: 1-415
comparison_key: 72c39cf07ede2a6be9591b87675613395088be8b
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-1-415
...
line_index_end: 423
line_index_start: 415
note_type: regulation_unit
page_end: null
page_start: null
parent_clause_path: null
parent_clause_text: null
parent_title: 1) 부분 자율주행시스템은 다음 그림의 음영(陰影)으로 표시된 부분을 포함하는
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 1-415
source_collection: xml_kmvss
source_url: null
statement: 1) 부분 자율주행시스템은 다음 그림의 음영(陰影)으로 표시된 부분을 포함하는
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `1-415` from xml_kmvss-kmvss_att_0027_128.
title: 1) 부분 자율주행시스템은 다음 그림의 음영(陰影)으로 표시된 부분을 포함하는
updated: '2026-04-13'
---

# 1) 부분 자율주행시스템은 다음 그림의 음영(陰影)으로 표시된 부분을 포함하는
