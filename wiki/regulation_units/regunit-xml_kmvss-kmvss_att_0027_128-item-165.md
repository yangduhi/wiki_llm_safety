...
basis: '마) 위 나)부터 라)까지의 규정에 따라 자동차로유지기능이 해제되거나 부분

  자율주행시스템이 운전전환요구를 한 경우에는 마목에 따른 운전자와 자

  동차 간 상호작용에 대한 기준에 따라 운전자에게 알릴 것'
browse_buckets: []
clause_path: item-165
comparison_key: 262e881b81b32994e45e93b185af65b3ca409c0d
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-item-165
...
parent_title: 마) 위 나)부터 라)까지의 규정에 따라 자동차로유지기능이 해제되거나 부분
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / item-165
source_collection: xml_kmvss
source_url: null
statement: 마) 위 나)부터 라)까지의 규정에 따라 자동차로유지기능이 해제되거나 부분
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `item-165` from xml_kmvss-kmvss_att_0027_128.
title: 마) 위 나)부터 라)까지의 규정에 따라 자동차로유지기능이 해제되거나 부분
updated: '2026-04-13'
---

# 마) 위 나)부터 라)까지의 규정에 따라 자동차로유지기능이 해제되거나 부분
