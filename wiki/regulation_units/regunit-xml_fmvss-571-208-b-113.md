...
basis: (b) Position the dummy in a kneeling position in any front outboard passenger
  vehicle seat with the dummy facing the front of the vehicle with its toes at the
  intersection of the seat back and seat cushion. Position the dummy so that the spine
  is vertical. Push down on the legs so that they contact the seat as much as possible
  and then release. Place the arms parallel to the spine.
browse_buckets:
- occupant_restraints
- seat_systems
clause_path: b-113
comparison_key: f2de4b1df22d88a70d245feca376a0b899f44121
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-b-113
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / b-113
...
status: draft
subject: null
summary: Regulation unit `b-113` from xml_fmvss-571-208.
title: (b) Position the dummy in a kneeling position in any front outboard passenger
  vehicle seat with the dummy facing the fro
updated: '2026-04-13'
---

# (b) Position the dummy in a kneeling position in any front outboard passenger vehicle seat with the dummy facing the fro
