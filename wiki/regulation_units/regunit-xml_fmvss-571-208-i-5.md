...
basis: '(i) The heading area shall be yellow with the word “WARNING” and the alert
  symbol in black.

  (ii) The message area shall be white with black text. The message area shall be
  no less than 30 cm 2 (4.7 in 2 ).

  (iii) The pictogram shall be black with a red circle and slash on a white background.
  The pictogram shall be no less than 30 mm (1.2 in) in diameter.

  (iv) If the vehicle does not have a back seat, the label shown in Figure 6a or 6b
  may be modified by omitting the statements: “The BACK SEAT is the SAFEST place for
  children.”'
browse_buckets:
- occupant_restraints
- head_impact
...
- seat_systems
clause_path: i-5
comparison_key: bf2a23b2ef6973ba3d494223d3e0996c13ebe4be
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-i-5
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / i-5
source_collection: xml_fmvss
source_url: null
statement: (i) The heading area shall be yellow with the word “WARNING” and the alert
  symbol in black.
status: draft
subject: null
summary: Regulation unit `i-5` from xml_fmvss-571-208.
title: (i) The heading area shall be yellow with the word “WARNING” and the alert
  symbol in black.
updated: '2026-04-13'
---
...
- browse_buckets: occupant_restraints, head_impact, child_restraints, seat_systems
- legacy_domain: passive_crash
