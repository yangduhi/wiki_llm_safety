...
basis: '1.1.1.
  ...
  Vehicles on which operation of the braking system requires the use of stored energy

  provided by hydraulic fluid under pressure shall be equipped with energy storage

  devices (energy accumulators) of a capacity meeting the requirements of

  paragraph 1.2. of this annex (Part C).'
browse_buckets: []
clause_path: annex-7-1-1-1-3
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-1-1-1-3
...
status: draft
subject: null
summary: Regulation unit `annex-7-1-1-1-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-1-1-1-3
- source_url: n/a
- confidence: medium
