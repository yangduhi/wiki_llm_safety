...
statement: S6.5.2. Test speeds. If a vehicle is incapable of attaining the specified
  ...
  that is 4 to 8 km/h (2.5 to 5.0 mph) less than its maximum speed and its performance
  must be within a stopping distance given by the formula provided for the specific
  requirement.
status: draft
subject: null
...
# S6.5.2. Test speeds. If a vehicle is incapable of attaining the specified normal test speed, it is tested at a speed tha
