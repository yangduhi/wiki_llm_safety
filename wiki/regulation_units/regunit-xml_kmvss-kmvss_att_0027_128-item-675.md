...
basis: 마) 위 라)의 신호는 운전전환요구신호와 구분되도록 표시할 것
browse_buckets: []
clause_path: item-675
comparison_key: 9ec4ab0d5a771a935a71f7978332d488db6805d0
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-item-675
...
page_end: null
page_start: null
parent_clause_path: 1-573
parent_clause_text: 1) 부분 자율주행시스템은 운전자에게 다음의 구분에 따른 신호를 할 것. 이 경
parent_title: 마) 위 라)의 신호는 운전전환요구신호와 구분되도록 표시할 것
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / item-675
source_collection: xml_kmvss
source_url: null
statement: 마) 위 라)의 신호는 운전전환요구신호와 구분되도록 표시할 것
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `item-675` from xml_kmvss-kmvss_att_0027_128.
title: 마) 위 라)의 신호는 운전전환요구신호와 구분되도록 표시할 것
updated: '2026-04-13'
---

# 마) 위 라)의 신호는 운전전환요구신호와 구분되도록 표시할 것
