...
basis: (d) The vehicle switch or device that provides power from the REESS to the
  electric power train is set to the activated position or the active driving possible
  mode.
browse_buckets: []
clause_path: d-7
comparison_key: c687e203a262101ce632b7ada546526c6a917b14
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305a-d-7
...
phase: post_crash
primary_topic: d-the-vehicle-switch-or-device-that-provides-power-from-the-reess-to-the-electri
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-305a / d-7
source_collection: xml_fmvss
source_url: null
statement: (d) The vehicle switch or device that provides power from the REESS to
  the electric power train is set to the activated position or the active driving
  possible mode.
status: draft
subject: null
summary: Regulation unit `d-7` from xml_fmvss-571-305a.
title: '(d) The vehicle switch or device that provides power from the REESS to the
  electric power train is set to the activated '
updated: '2026-04-13'
---

# (d) The vehicle switch or device that provides power from the REESS to the electric power train is set to the activated 
