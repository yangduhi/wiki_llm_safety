...
basis: '(d)
  ...
  Following the thermal and pressure cycling, the pressure relief device

  shall comply with the requirements of Leak test (Annex 4, paragraph

  1.8.), except that the Leak test shall be conducted at -40 °C (+5/-0 °C).

  After the Leak test, the TPRD shall comply with the requirements of

  Bench top activation test (Annex 4, paragraph 1.9.) and then Flow rate

  test (Annex 4, paragraph 1.10.).'
browse_buckets:
- fuel_system_integrity
clause_path: annex-4-d
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-4-d
...
status: draft
subject: null
summary: Regulation unit `annex-4-d` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: (d)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-4-d
- source_url: n/a
- confidence: medium
