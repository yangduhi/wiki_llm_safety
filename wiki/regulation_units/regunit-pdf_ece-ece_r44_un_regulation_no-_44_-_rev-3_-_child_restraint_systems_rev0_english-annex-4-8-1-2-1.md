...
attachment_section: Annex 4. In tests with complete vehicles it shall be possible
  to remove the
basis: '8.1.2.1.

  The manikin shall be equipped with the load application device as described

  in Annex 23 and placed in the restraints installed in accordance with this

  Regulation and taking into account the manufacturer''s instructions and with

  the standard slack as specified in paragraph 8.1.3.6. below, applied for all

  systems identically.'
browse_buckets:
- child_restraints
clause_path: annex-4-8-1-2-1
comparison_key: ca5bee1053b1189b8c85f62144c4be53654acd4b
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english-annex-4-8-1-2-1
...
status: draft
subject: null
summary: Regulation unit `annex-4-8-1-2-1` from pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english.
title: 8.1.2.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english / annex-4-8-1-2-1
- source_url: n/a
- confidence: medium
