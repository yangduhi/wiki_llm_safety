...
basis: '2.3.
  ...
  The steering control shall be tested complete with trim. The steering control

  must have a minimum collapsing space of 100 mm between the steering

  control and the test bench. The steering shaft shall be firmly attached to the

  test bench so that the steering shaft does not move under impact (see fig. 1).'
browse_buckets:
- steering_control
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english-annex-5-2-3
...
status: draft
subject: null
summary: Regulation unit `annex-5-2-3` from pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english.
title: 2.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english / annex-5-2-3
- source_url: n/a
- confidence: medium
