...
basis: '8) 자동차로유지기능이 해제되는 경우에는 자동차의 관련 기능이 다음과 같이

  작동되도록 할 것'
browse_buckets: []
clause_path: 8-189
comparison_key: ec36b0d731d4f42f3031187e0c16c28016959b3e
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-8-189
...
parent_title: 8) 자동차로유지기능이 해제되는 경우에는 자동차의 관련 기능이 다음과 같이
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 8-189
source_collection: xml_kmvss
source_url: null
statement: 8) 자동차로유지기능이 해제되는 경우에는 자동차의 관련 기능이 다음과 같이
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `8-189` from xml_kmvss-kmvss_att_0027_128.
title: 8) 자동차로유지기능이 해제되는 경우에는 자동차의 관련 기능이 다음과 같이
updated: '2026-04-13'
---

# 8) 자동차로유지기능이 해제되는 경우에는 자동차의 관련 기능이 다음과 같이
