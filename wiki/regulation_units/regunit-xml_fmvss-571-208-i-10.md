...
basis: '(i) The heading area shall be yellow with the word “WARNING” and the alert
  ...
  (iii) If the vehicle does not have a back seat, the label shown in Figure 7 may
...
id: regunit-xml_fmvss-571-208-i-10
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / i-10
...
status: draft
subject: null
summary: Regulation unit `i-10` from xml_fmvss-571-208.
