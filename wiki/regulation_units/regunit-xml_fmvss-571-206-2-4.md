...
basis: (2) Apply the test load, in the direction specified in S4.1.1.2 and Figure
  5, at a rate not to exceed 5 mm/min until the required load has been achieved. Record
  the maximum load achieved.
browse_buckets:
- door_retention
clause_path: 2-4
comparison_key: b730a4bffa4d30cba6a86f3d51bf664110cc47a9
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-2-4
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / 2-4
source_collection: xml_fmvss
source_url: null
statement: (2) Apply the test load, in the direction specified in S4.1.1.2 and Figure
  5, at a rate not to exceed 5 mm/min until the required load has been achieved. Record
  the maximum load achieved.
status: draft
subject: null
summary: Regulation unit `2-4` from xml_fmvss-571-206.
title: (2) Apply the test load, in the direction specified in S4.1.1.2 and Figure
  5, at a rate not to exceed 5 mm/min until the
updated: '2026-04-13'
---

# (2) Apply the test load, in the direction specified in S4.1.1.2 and Figure 5, at a rate not to exceed 5 mm/min until the
