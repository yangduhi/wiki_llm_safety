...
basis: '1.2.
  ...
  The barrier consists of a block of reinforced concrete not less than 3 m wide

  at the front and not less than 1.5 m high. The barrier shall be of such

  thickness that it weighs at least 70 tonnes. The front face shall be vertical,

  perpendicular to the axis of the run-up track, and covered with plywood

  boards 20 ± 1 mm thick in good condition. The barrier shall be either

  anchored in the ground or placed on the ground with, if necessary, additional

  arresting devices to limit its displacement. A barrier with different

  characteristics, but giving results at least equally conclusive, may likewise be

  used.'
browse_buckets:
- child_restraints
clause_path: annex-9-1-2
comparison_key: 23c9f429c9e13205ab3a48973360c9266c281db0
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-9-1-2
...
status: draft
subject: null
summary: Regulation unit `annex-9-1-2` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 1.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-9-1-2
- source_url: n/a
- confidence: medium
