...
basis: (b) 100 ohms/volt for an AC high voltage source if it is conductively connected
  ...
  for protection against direct contact in S6.1.4 and the protection from indirect
  contact in S6.2; or
browse_buckets: []
clause_path: b-5
comparison_key: 0fa2ad80e11cbc32a3d2e8ef2cf44ec39c547be2
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305a-b-5
...
- high_voltage
sectno: null
source_citation: xml_fmvss-571-305a / b-5
...
status: draft
subject: null
summary: Regulation unit `b-5` from xml_fmvss-571-305a.
