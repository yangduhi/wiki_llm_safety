...
basis: S8.2 Preparing dummies. When using the Q3s dummy, install the IR-TRACC on the
  ...
  from 20.6° to 22.2 °C and at any relative humidity from 10 percent to 70 percent,
...
statement: S8.2 Preparing dummies. When using the Q3s dummy, install the IR-TRACC
  ...
  in testing under this standard, test dummies must be conditioned at any ambient
...
# S8.2 Preparing dummies. When using the Q3s dummy, install the IR-TRACC on the test impact side according to 49 CFR part 
