...
basis: '(b)
  ...
  If more than one container is used to execute the four drop

  orientations, and if all containers reach 22,000 cycles without leakage,

  then the orientation of the container being dropped in accordance with

  the requirement paragraph 5.2.2. is the 45o orientation (iv), and that

  container shall then undergo further testing as specified in paragraph

  5.2.;'
browse_buckets:
- fuel_system_integrity
clause_path: annex-3-b-12
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-3-b-12
...
status: draft
subject: null
summary: Regulation unit `annex-3-b-12` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-3-b-12
- source_url: n/a
- confidence: medium
