...
basis: (a) For all barrier crashes, the injury criteria specified in this standard
  shall be met when calculated based on data recorded for 300 milliseconds after the
  vehicle strikes the barrier.
browse_buckets:
- occupant_restraints
clause_path: a-35
comparison_key: dcada897060de046f5b7c18d741b0210956884eb
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-a-35
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / a-35
source_collection: xml_fmvss
source_url: null
statement: (a) For all barrier crashes, the injury criteria specified in this standard
  shall be met when calculated based on data recorded for 300 milliseconds after the
  vehicle strikes the barrier.
status: draft
subject: null
summary: Regulation unit `a-35` from xml_fmvss-571-208.
title: (a) For all barrier crashes, the injury criteria specified in this standard
  shall be met when calculated based on data r
updated: '2026-04-13'
---

# (a) For all barrier crashes, the injury criteria specified in this standard shall be met when calculated based on data r
