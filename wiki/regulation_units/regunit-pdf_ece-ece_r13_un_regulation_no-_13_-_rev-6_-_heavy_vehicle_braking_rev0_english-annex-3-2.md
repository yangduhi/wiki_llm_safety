...
attachment_section: Annex 3 to this Regulation gives examples of arrangements of approval
  marks.
basis: (2) When different from minimum cut-in pressure;
browse_buckets: []
clause_path: annex-3-2
comparison_key: 1908bc44046dea9e3add892682f85aa393bd2665
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-3-2
...
phase: cross_phase
primary_topic: 2-when-different-from-minimum-cut-in-pressure
provenance:
...
source_url: null
statement: (2) When different from minimum cut-in pressure;
status: draft
subject: null
summary: Regulation unit `annex-3-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (2) When different from minimum cut-in pressure;
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-3-2
- source_url: n/a
- confidence: medium
