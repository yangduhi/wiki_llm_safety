...
basis: '1.1.
  ...
  Post-crash leak test: compressed hydrogen storage system filled with
  ...
  impact and continues for at least 60 minutes. The time interval, Δt, shall be

  increased, if necessary, to accommodate measurement accuracy for a storage

  system with a large volume operating up to 70MPa; in that case, Δt is
  ...
  compressed hydrogen storage system (L), and Δt is the time interval (min). If
...
comparison_key: cb2ffacc9f81fdfe4b8472f19172c88cfc217a40
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-5-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-5-1-1` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: 1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-5-1-1
- source_url: n/a
- confidence: medium
