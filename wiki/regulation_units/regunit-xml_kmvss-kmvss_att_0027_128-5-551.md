...
basis: '다) 위 나) 단서에 따라 자동차가 정지된 경우에는 5초 이내에 비상점멸표시

  등을 점멸시킬 것'
browse_buckets: []
clause_path: 5-551
comparison_key: 082f9a0904d4d6cbb8a05ed46ec5c496840db5cb
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-5-551
...
parent_title: 다) 위 나) 단서에 따라 자동차가 정지된 경우에는 5초 이내에 비상점멸표시
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 5-551
source_collection: xml_kmvss
source_url: null
statement: 다) 위 나) 단서에 따라 자동차가 정지된 경우에는 5초 이내에 비상점멸표시
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `5-551` from xml_kmvss-kmvss_att_0027_128.
title: 다) 위 나) 단서에 따라 자동차가 정지된 경우에는 5초 이내에 비상점멸표시
updated: '2026-04-13'
---

# 다) 위 나) 단서에 따라 자동차가 정지된 경우에는 5초 이내에 비상점멸표시
