...
basis: (b) In the case of a primary door latch system, when in the secondary latched
  position, the door latch system shall not separate when a load of 4,500 N is applied
  in the same direction specified in paragraph (a) of this section when tested in
  accordance with S5.2.1.2.
browse_buckets:
- door_retention
clause_path: b-9
comparison_key: 6bd02eea3aa9a94fc302a6e9d7b52d1fc3363dcf
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-b-9
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / b-9
source_collection: xml_fmvss
source_url: null
statement: (b) In the case of a primary door latch system, when in the secondary latched
  position, the door latch system shall not separate when a load of 4,500 N is applied
  in the same direction specified in paragraph (a) of this section when tested in
  accordance with S5.2.1.2.
status: draft
subject: null
summary: Regulation unit `b-9` from xml_fmvss-571-206.
title: '(b) In the case of a primary door latch system, when in the secondary latched
  position, the door latch system shall not '
updated: '2026-04-13'
---

# (b) In the case of a primary door latch system, when in the secondary latched position, the door latch system shall not 
