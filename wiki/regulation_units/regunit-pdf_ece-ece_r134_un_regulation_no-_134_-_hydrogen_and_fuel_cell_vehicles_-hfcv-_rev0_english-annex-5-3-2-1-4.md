...
basis: '3.2.1.4.
  ...
  For the purpose of the test, a hydrogen concentration detector is installed

  where hydrogen gas may accumulate most in the passenger compartment

  (e.g. near the headliner) when testing for compliance with paragraph 7.1.4.2.

  of this Regulation and hydrogen concentration detectors are installed in

  enclosed or semi enclosed volumes on the vehicle where hydrogen can

  accumulate from the simulated hydrogen releases when testing for

  compliance with paragraph 7.1.4.3. of this Regulation (see Annex 5,
...
clause_path: annex-5-3-2-1-4
comparison_key: c1befdf60107db0ad497945c2014ccf84cb59e09
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-5-3-2-1-4
...
status: draft
subject: null
summary: Regulation unit `annex-5-3-2-1-4` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: 3.2.1.4.
updated: '2026-04-13'
---
...
- browse_buckets: occupant_compartment_integrity, head_impact, fuel_system_integrity
- legacy_domain: needs_review
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-5-3-2-1-4
- source_url: n/a
- confidence: medium
