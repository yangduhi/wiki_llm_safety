...
basis: '5.3.7.
  ...
  correction is permitted, if the angular rotation of the steering control is within

  120 ° during the initial two seconds, and not more than 240 ° in all. Furthermore,

  at the beginning of these tests the longitudinal median plane of the vehicle shall

  pass over the boundary between the high- and low-adhesion surfaces and during

  these tests no part of the (outer) tyres shall cross this boundary. 7/'
browse_buckets:
- steering_control
clause_path: annex-13-5-3-7
comparison_key: efd649a68aed41a64cd2100154b45b20c81bea3f
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-5-3-7
...
status: draft
subject: null
summary: Regulation unit `annex-13-5-3-7` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.3.7.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-5-3-7
- source_url: n/a
- confidence: medium
