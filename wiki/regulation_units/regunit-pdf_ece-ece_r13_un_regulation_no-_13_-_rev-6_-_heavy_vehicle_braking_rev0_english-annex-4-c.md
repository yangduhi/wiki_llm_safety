...
basis: '(c) at the maximum level which results from automatic charge control on the

  vehicle.'
browse_buckets: []
clause_path: annex-4-c
comparison_key: 69981620a2d1835268501ec8fdc4ff7d441679c9
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-c
...
phase: cross_phase
primary_topic: c-at-the-maximum-level-which-results-from-automatic-charge-control-on-the
provenance:
...
source_url: null
statement: (c) at the maximum level which results from automatic charge control on
  the
status: draft
subject: null
summary: Regulation unit `annex-4-c` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (c) at the maximum level which results from automatic charge control on the
updated: '2026-04-13'
---

# (c) at the maximum level which results from automatic charge control on the
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-c
- source_url: n/a
- confidence: medium
