...
basis: '17.1.
  ...
  Upon reception of a triggering signal, the AECD shall send data and establish

  voice connection with the PSAP.

  If the sending of data failed, then the AECD shall retry sending the data.

  If the AECD has successfully sent the data and then loses the voice
  ...
  using PLMN, the AECD shall store the data in non-volatile memory and

  attempt re-transmission of the data and to establish a voice connection.'
browse_buckets: []
clause_path: 17-1
comparison_key: 6d8dd67b5ddcc28f0d5939b4c8fd1b1e32cd067b
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-17-1
...
status: draft
subject: null
summary: Regulation unit `17-1` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: 17.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / 17-1
- source_url: n/a
- confidence: medium
