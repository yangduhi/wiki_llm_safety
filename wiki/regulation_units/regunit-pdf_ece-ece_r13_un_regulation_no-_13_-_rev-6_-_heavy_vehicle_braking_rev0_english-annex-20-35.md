...
basis: 'Annex 20 - Appendix 5
  ...
  which the limit of adhesion is reached

  TRLf

  sum of braking forces at periphery of all wheels of the front axle(s) at which

  the limit of adhesion is reached

  TRLr

  sum of braking forces at periphery of all wheels of the rear axle(s) at which the
  ...
  required to achieve the prescribed performance

  TRprf

  sum of braking forces at periphery of all wheels of the front axle(s) required to

  achieve the prescribed performance

  TRprr

  sum of braking forces at periphery of all wheels of the rear axle(s) required to
  ...
  cosine of angle subtended by slope of 18 per cent and horizontal
...
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-20-35
...
status: draft
subject: null
summary: Regulation unit `annex-20-35` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
...
DEFINITION
TRL
sum of braking forces at periphery of all wheels of the trailer or semi-trailer at
which the limit of adhesion is reached
TRLf
sum of braking forces at periphery of all wheels of the front axle(s) at which
the limit of adhesion is reached
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-20-35
- source_url: n/a
- confidence: medium
