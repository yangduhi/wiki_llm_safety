...
basis: (3) = TRprf = TRf , when pm = x
browse_buckets: []
clause_path: annex-20-3-6
comparison_key: b3e9bd76134f51aa435c55a811f57e80250c90fc
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-20-3-6
...
phase: cross_phase
primary_topic: 3-trprf-trf-when-pm-x
provenance:
...
source_url: null
statement: (3) = TRprf = TRf , when pm = x
status: draft
subject: null
summary: Regulation unit `annex-20-3-6` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (3) = TRprf = TRf , when pm = x
updated: '2026-04-13'
---

# (3) = TRprf = TRf , when pm = x
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-20-3-6
- source_url: n/a
- confidence: medium
