...
basis: (a) Extend the arms of the test dummy as far as possible in the upward vertical
...
- child_restraints
clause_path: a-11
comparison_key: 4bd98162b10dd032463e582324dbb424523aa916
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213a-a-11
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213a / a-11
source_collection: xml_fmvss
source_url: null
statement: (a) Extend the arms of the test dummy as far as possible in the upward
  vertical direction. Extend the legs of the dummy as far as possible in the forward
  horizontal direction, with the dummy feet perpendicular to the center line of the
  lower legs.
status: draft
subject: null
summary: Regulation unit `a-11` from xml_fmvss-571-213a.
title: '(a) Extend the arms of the test dummy as far as possible in the upward vertical
  direction. Extend the legs of the dummy '
updated: '2026-04-13'
---

# (a) Extend the arms of the test dummy as far as possible in the upward vertical direction. Extend the legs of the dummy 
