...
basis: (c) Locate the loading device as shown in Figure 1 (side view) of this section
  so that—
browse_buckets:
- side_impact
clause_path: c-3
comparison_key: acc41145c8a2c0762ccaefc26f1c76f4bdb389c0
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-214-c-3
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-214 / c-3
source_collection: xml_fmvss
source_url: null
statement: (c) Locate the loading device as shown in Figure 1 (side view) of this
  section so that—
status: draft
subject: null
summary: Regulation unit `c-3` from xml_fmvss-571-214.
title: (c) Locate the loading device as shown in Figure 1 (side view) of this section
  so that—
updated: '2026-04-13'
---
