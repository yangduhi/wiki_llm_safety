...
basis: (b) If the child restraint is certified to S5.9 of § 571.213, and the vehicle
  seat has an anchorage system as specified in § 571.225, using only the mechanism
  provided by the child restraint manufacturer for attachment to the lower anchorage
  as specified in S22.2.1.6; and
browse_buckets:
- occupant_restraints
- child_restraints
- seat_systems
clause_path: b-118
comparison_key: b9043816552e496f0c0cdc8870b3726cc044a93e
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-b-118
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / b-118
source_collection: xml_fmvss
source_url: null
statement: (b) If the child restraint is certified to S5.9 of § 571.213, and the vehicle
  seat has an anchorage system as specified in § 571.225, using only the mechanism
  provided by the child restraint manufacturer for attachment to the lower anchorage
  as specified in S22.2.1.6; and
status: draft
subject: null
summary: Regulation unit `b-118` from xml_fmvss-571-208.
title: '(b) If the child restraint is certified to S5.9 of § 571.213, and the vehicle
  seat has an anchorage system as specified '
updated: '2026-04-13'
---

# (b) If the child restraint is certified to S5.9 of § 571.213, and the vehicle seat has an anchorage system as specified 
