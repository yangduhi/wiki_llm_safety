...
basis: '(b)
  ...
  It is ascertained that at a constant speed equivalent to v = 60 km/h with the

  brake(s) released the asymptotic temperature shall not exceed a drum/disc

  temperature increase of 80 °C, then this residual brake moment is regarded as

  acceptable."'
browse_buckets: []
clause_path: annex-11-b
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-11-b
...
status: draft
subject: null
summary: Regulation unit `annex-11-b` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-11-b
- source_url: n/a
- confidence: medium
