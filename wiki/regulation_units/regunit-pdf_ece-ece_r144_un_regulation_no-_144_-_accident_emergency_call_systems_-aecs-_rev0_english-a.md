...
basis: '(a)
  ...
  Part Ia: the approval of Accident Emergency Call Components

  (AECC) which are intended to be fitted as part of an Accident

  Emergency Call Device (AECD).'
browse_buckets: []
clause_path: a
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-a
...
status: draft
subject: null
summary: Regulation unit `a` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: (a)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / a
- source_url: n/a
- confidence: medium
