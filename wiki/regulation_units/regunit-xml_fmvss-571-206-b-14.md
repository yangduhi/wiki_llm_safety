...
basis: (b) Apply the test load, in the direction specified in S4.1.1.3 and Figure
  5, at a rate not to exceed 5 mm/min until the required load has been achieved. Record
  the maximum load required.
browse_buckets:
- door_retention
clause_path: b-14
comparison_key: 02448ec617cfaab3a20502c06c7230f5c057d132
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-b-14
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / b-14
source_collection: xml_fmvss
source_url: null
statement: (b) Apply the test load, in the direction specified in S4.1.1.3 and Figure
  5, at a rate not to exceed 5 mm/min until the required load has been achieved. Record
  the maximum load required.
status: draft
subject: null
summary: Regulation unit `b-14` from xml_fmvss-571-206.
title: (b) Apply the test load, in the direction specified in S4.1.1.3 and Figure
  5, at a rate not to exceed 5 mm/min until the
updated: '2026-04-13'
---

# (b) Apply the test load, in the direction specified in S4.1.1.3 and Figure 5, at a rate not to exceed 5 mm/min until the
