...
basis: '3.3.1.
  ...
  The axle should preferably be loaded with the maximum static axle mass though

  this is not essential provided that due allowance is made during the tests for the

  difference in rolling resistance caused by a different mass on the test axle.'
browse_buckets: []
clause_path: annex-11-3-3-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-11-3-3-1
...
status: draft
subject: null
summary: Regulation unit `annex-11-3-3-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.3.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-11-3-3-1
- source_url: n/a
- confidence: medium
