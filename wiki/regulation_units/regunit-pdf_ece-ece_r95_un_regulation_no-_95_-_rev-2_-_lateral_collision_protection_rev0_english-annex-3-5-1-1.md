...
basis: '5.1.1.
  ...
  The test will be carried out on the driver’s side unless asymmetric side

  structures, if any, are so different as to affect the performance in a side

  impact. In that case either of the alternatives in paragraph 5.1.1.1. or 5.1.1.2.

  below may be used by agreement between the manufacturer and Type

  Approval Authority.'
browse_buckets:
- side_impact
clause_path: annex-3-5-1-1
comparison_key: 3f649fda35b700fcc3c996c836557837f9054cba
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english-annex-3-5-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-3-5-1-1` from pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english.
title: 5.1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english / annex-3-5-1-1
- source_url: n/a
- confidence: medium
