...
basis: '1.4.
  ...
  Global Navigation Satellite System (GNSS) position determination may be

  approved at the request of the applicant.

  1 As defined in Section 2 of the Consolidated Resolution on the Construction of
  Vehicles (R.E.3)
  ...
  However, if the applicant opts to request approval of a AECD/AECS or

  AECC without the GNSS positioning as described in this Regulation,

  national requirements of the Contracting Parties apply.'
browse_buckets: []
clause_path: 1-4
comparison_key: f1f74565708bb1ce36753516a63f44e0448d9f84
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-1-4
...
status: draft
subject: null
summary: Regulation unit `1-4` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: 1.4.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / 1-4
- source_url: n/a
- confidence: medium
