...
basis: '(c)
  ...
  In the event of a failure of the ISO 7638:1997 power supply the energy

  consumed by the braking system shall not result in the maximum available

  power from the additional supply being exceeded.'
browse_buckets: []
clause_path: annex-10-c
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-10-c
...
status: draft
subject: null
summary: Regulation unit `annex-10-c` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (c)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-10-c
- source_url: n/a
- confidence: medium
