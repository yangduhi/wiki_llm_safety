...
basis: '5.3.1.
  ...
  Based on the information supplied in the information document, in particular the

  trailer applications defined in paragraph 2.1. of Appendix 5, the Technical Service

  shall carry out tests on representative trailers having up to three axles and
  ...
  Additionally, when selecting trailers for evaluation consideration shall also be

  given to the parameters defined in the following paragraphs.'
browse_buckets:
- side_impact
clause_path: annex-19-5-3-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-19-5-3-1
...
status: draft
subject: null
summary: Regulation unit `annex-19-5-3-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.3.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-19-5-3-1
- source_url: n/a
- confidence: medium
