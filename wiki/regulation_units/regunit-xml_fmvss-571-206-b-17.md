...
basis: (B) Longitudinal Setup 2. Orient the vehicle so that its longitudinal axis
  is aligned with the axis of the acceleration device, simulating a rear impact.
browse_buckets:
- rear_impact
- door_retention
clause_path: b-17
comparison_key: c4c50b65d3bd51db5e7b808410f19dcc857c9d35
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-b-17
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / b-17
source_collection: xml_fmvss
source_url: null
statement: (B) Longitudinal Setup 2. Orient the vehicle so that its longitudinal axis
  is aligned with the axis of the acceleration device, simulating a rear impact.
status: draft
subject: null
summary: Regulation unit `b-17` from xml_fmvss-571-206.
title: '(B) Longitudinal Setup 2. Orient the vehicle so that its longitudinal axis
  is aligned with the axis of the acceleration '
updated: '2026-04-13'
---

# (B) Longitudinal Setup 2. Orient the vehicle so that its longitudinal axis is aligned with the axis of the acceleration 
