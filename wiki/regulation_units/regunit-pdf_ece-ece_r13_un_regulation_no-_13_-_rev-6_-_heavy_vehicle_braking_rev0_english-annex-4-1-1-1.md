...
basis: '1.1.1.
  ...
  The performance prescribed for braking systems is based on the stopping distance

  and/or the mean fully developed deceleration. The performance of a braking

  system shall be determined by measuring the stopping distance in relation to the

  initial speed of the vehicle and/or by measuring the mean fully developed

  deceleration during the test.'
browse_buckets: []
clause_path: annex-4-1-1-1
comparison_key: 1d7aa21d330780a34af665eed9f2142653de0315
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-1-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-4-1-1-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-1-1-1
- source_url: n/a
- confidence: medium
