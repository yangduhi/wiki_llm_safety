...
basis: '3.2.
  ...
  The braking effect may commence with an initial braking force, which shall not be
  higher

  than 10 per cent of the (sum of the) maximum stationary axle load(s) nor higher

  than 13 per cent of the (sum of the) stationary axle load(s) of the unladen trailer.'
browse_buckets: []
clause_path: annex-14-3-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-14-3-2
...
status: draft
subject: null
summary: Regulation unit `annex-14-3-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.2.
updated: '2026-04-13'
---
...
## Basis
3.2.
The braking effect may commence with an initial braking force, which shall not be higher
than 10 per cent of the (sum of the) maximum stationary axle load(s) nor higher
than 13 per cent of the (sum of the) stationary axle load(s) of the unladen trailer.
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-14-3-2
- source_url: n/a
- confidence: medium
