...
basis: (2) The message area must be white with black text. The message area must be
  no less than 20 square centimeters.
browse_buckets:
- child_restraints
clause_path: 2-5
comparison_key: 03f23e879d80b341e865c7a706c4967d194ad8e2
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213b-2-5
...
phase: cross_phase
primary_topic: 2-the-message-area-must-be-white-with-black-text-the-message-area-must-be-no-les
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213b / 2-5
source_collection: xml_fmvss
source_url: null
statement: (2) The message area must be white with black text. The message area must
  be no less than 20 square centimeters.
status: draft
subject: null
summary: Regulation unit `2-5` from xml_fmvss-571-213b.
title: (2) The message area must be white with black text. The message area must be
  no less than 20 square centimeters.
updated: '2026-04-13'
---
