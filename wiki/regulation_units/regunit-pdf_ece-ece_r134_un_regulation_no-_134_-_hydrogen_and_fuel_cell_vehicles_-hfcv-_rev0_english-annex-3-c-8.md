...
basis: '(c)
  ...
  orientations and if any container does not reach 22,000 cycles without

  leakage, then the new container shall be subjected to the drop

  orientation(s) that resulted in the lowest number of cycles to leakage

  and then will undergo further testing as specified in paragraph 5.2.'
browse_buckets:
- fuel_system_integrity
clause_path: annex-3-c-8
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-3-c-8
...
status: draft
subject: null
summary: Regulation unit `annex-3-c-8` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: (c)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-3-c-8
- source_url: n/a
- confidence: medium
