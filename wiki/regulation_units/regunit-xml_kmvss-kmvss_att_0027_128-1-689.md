...
basis: '1) 위험최소화운행이 시작되면 주행 중인 차로(차선표시가 분명하지 않은 경우

  에는 주변의 교통 및 도로 환경을 고려한 적절한 경로로 한다)에서 4㎨를 초

  과하지 않는 감속도로 감속할 것. 다만, 다음에 해당하는 경우에는 4㎨를 초

  과할 수 있다.'
browse_buckets: []
clause_path: 1-689
comparison_key: 2247c4021124915cb2a0c77f2d409a971460ef67
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-1-689
...
parent_title: 1) 위험최소화운행이 시작되면 주행 중인 차로(차선표시가 분명하지 않은 경우
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 1-689
source_collection: xml_kmvss
source_url: null
statement: 1) 위험최소화운행이 시작되면 주행 중인 차로(차선표시가 분명하지 않은 경우
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `1-689` from xml_kmvss-kmvss_att_0027_128.
title: 1) 위험최소화운행이 시작되면 주행 중인 차로(차선표시가 분명하지 않은 경우
updated: '2026-04-13'
---

# 1) 위험최소화운행이 시작되면 주행 중인 차로(차선표시가 분명하지 않은 경우
