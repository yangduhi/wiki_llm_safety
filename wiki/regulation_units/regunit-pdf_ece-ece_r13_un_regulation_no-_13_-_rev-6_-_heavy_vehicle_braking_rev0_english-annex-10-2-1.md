...
basis: '2.1.
  ...
  The broken lines shown on diagram 4B refer to the determination of the factors Kc

  and Kv for the following vehicle, where:
  ...
  In the following paragraphs the figures in parentheses relate only to the vehicle
  being

  used for the purpose of illustrating the method of using diagram 4B.'
browse_buckets: []
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-10-2-1
...
status: draft
subject: null
summary: Regulation unit `annex-10-2-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.1.
updated: '2026-04-13'
---
...
6.0 m
6.0 m
In the following paragraphs the figures in parentheses relate only to the vehicle being
used for the purpose of illustrating the method of using diagram 4B.

## Authority
- clause_path: annex-10-2-1
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-10-2-1
- source_url: n/a
- confidence: medium
