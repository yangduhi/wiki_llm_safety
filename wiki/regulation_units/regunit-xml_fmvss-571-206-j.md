...
basis: (j) Place the load application structure so that the force application plates
  are in contact with the interior of the sliding door.
browse_buckets:
- door_retention
clause_path: j
comparison_key: dafdf1f77a454a0501179a86c83614efdb7a1170
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-j
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / j
source_collection: xml_fmvss
source_url: null
statement: (j) Place the load application structure so that the force application
  plates are in contact with the interior of the sliding door.
status: draft
subject: null
summary: Regulation unit `j` from xml_fmvss-571-206.
title: (j) Place the load application structure so that the force application plates
  are in contact with the interior of the sl
updated: '2026-04-13'
---

# (j) Place the load application structure so that the force application plates are in contact with the interior of the sl
