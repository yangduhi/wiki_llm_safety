...
basis: '2.2.2.
  ...
  The rigid barrier shall be either anchored in the ground or placed on the

  ground with, if necessary, additional arresting devices to limit its

  displacement. A rigid barrier with load cells having different characteristics

  but giving results that are at least equally conclusive may be used.'
browse_buckets: []
clause_path: annex-5-2-2-2-2
comparison_key: 87b70618dcedac59f002ac4eb24a31439cea8669
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english-annex-5-2-2-2-2
...
status: draft
subject: null
summary: Regulation unit `annex-5-2-2-2-2` from pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english.
title: 2.2.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english / annex-5-2-2-2-2
- source_url: n/a
- confidence: medium
