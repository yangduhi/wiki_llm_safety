...
basis: '1.2.5.
  ...
  In the case of a vehicle equipped with an anti-lock system of categories 1 or 2,
  the

  value of zAL will be based on the whole vehicle, with the anti-lock system

  operative, and the adhesion utilized (ε) is given by the same formula quoted in

  paragraph 1.2.1. of this appendix.'
browse_buckets: []
clause_path: annex-13-1-2-5
comparison_key: aa9a18079342b971e6b6fd3b7c9bd570db5429d1
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-1-2-5
...
status: draft
subject: null
summary: Regulation unit `annex-13-1-2-5` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.2.5.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-1-2-5
- source_url: n/a
- confidence: medium
