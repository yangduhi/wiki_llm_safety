...
basis: '(2) When using the Hybrid III 6-year-old dummy, prepare the dummy according
  to the following:'
browse_buckets:
- child_restraints
clause_path: 2-31
comparison_key: ee5975d23a114c6bc832e95194f0804c8df7548e
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-2-31
...
phase: cross_phase
primary_topic: 2-when-using-the-hybrid-iii-6-year-old-dummy-prepare-the-dummy-according-to-the-
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / 2-31
source_collection: xml_fmvss
source_url: null
statement: '(2) When using the Hybrid III 6-year-old dummy, prepare the dummy according
  to the following:'
status: draft
subject: null
summary: Regulation unit `2-31` from xml_fmvss-571-213.
title: '(2) When using the Hybrid III 6-year-old dummy, prepare the dummy according
  to the following:'
updated: '2026-04-13'
---
