...
basis: '(c)
  ...
  In height by two planes parallel to the X-Y plane positioned at

  distances of 285 mm and 540 mm below the origin along the X axis.

  It shall be permissible for the support-leg to be adjustable beyond the height

  limits in the Z direction, providing that no parts extend beyond the limiting
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-3-c-5
...
status: draft
subject: null
summary: Regulation unit `annex-3-c-5` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: (c)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-3-c-5
- source_url: n/a
- confidence: medium
