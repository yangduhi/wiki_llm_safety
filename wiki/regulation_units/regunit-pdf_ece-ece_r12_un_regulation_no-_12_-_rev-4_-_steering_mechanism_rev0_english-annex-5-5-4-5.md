...
basis: '5.4.5.
  ...
  Where adaptors are used to adapt a single type of steering control to a range

  of steering column, and it can be demonstrated that with such adaptors the

  energy-absorbing characteristics of the system are the same, all the tests may

  be performed with one type of adaptor.'
browse_buckets:
- steering_control
clause_path: annex-5-5-4-5
comparison_key: 7d566c8023583761d0c782c1e47088d206180058
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english-annex-5-5-4-5
...
status: draft
subject: null
summary: Regulation unit `annex-5-5-4-5` from pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english.
title: 5.4.5.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english / annex-5-5-4-5
- source_url: n/a
- confidence: medium
