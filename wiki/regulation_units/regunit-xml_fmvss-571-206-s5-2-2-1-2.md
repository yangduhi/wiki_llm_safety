...
basis: S5.2.2.1 Tests are conducted using a full vehicle with the sliding door and
  its retention components.
browse_buckets:
- door_retention
clause_path: s5-2-2-1-2
comparison_key: a4727677c3913bc42863c2580f009f93281ecccd
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-s5-2-2-1-2
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / s5-2-2-1-2
source_collection: xml_fmvss
source_url: null
statement: S5.2.2.1 Tests are conducted using a full vehicle with the sliding door
  and its retention components.
status: draft
subject: null
summary: Regulation unit `s5-2-2-1-2` from xml_fmvss-571-206.
title: S5.2.2.1 Tests are conducted using a full vehicle with the sliding door and
  its retention components.
updated: '2026-04-13'
---
