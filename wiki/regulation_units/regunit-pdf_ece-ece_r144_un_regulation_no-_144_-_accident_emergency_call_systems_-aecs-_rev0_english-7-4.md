...
basis: '7.4.
  ...
  If the applicant for approval so requests, the means of access to PLMN can

  be part of the approval of a type of AECC.

  In this case the following provision shall apply: the AECC shall be fitted with

  an embedded hardware allowing registration/authentication of, and access to

  a PLMN.'
browse_buckets: []
clause_path: 7-4
comparison_key: fa9cf6237101951a812392899550f894d68bc8e8
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-7-4
...
status: draft
subject: null
summary: Regulation unit `7-4` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: 7.4.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / 7-4
- source_url: n/a
- confidence: medium
