...
basis: '1.
  ...
  Door panel definition

  The dimension and initial position of the impact door relative to the bench

  are described in the following figures.

  The stiffness and strength of the door panel shall be sufficient to avoid

  excessive oscillation or significant deformation during lateral dynamic test.
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-6-1-3
...
status: draft
subject: null
summary: Regulation unit `annex-6-1-3` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: '1.'
updated: '2026-04-13'
---
...
- browse_buckets: side_impact, door_retention, child_restraints
- legacy_domain: passive_crash
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-6-1-3
- source_url: n/a
- confidence: medium
