...
basis: '3.4.
  ...
  Pressure required to produce a push rod stroke of 15 mm (p15) based on ThA – f(p)
  or

  declared value. 2/, 4/'
browse_buckets: []
clause_path: annex-19-3-4-3
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-19-3-4-3
...
status: draft
subject: null
summary: Regulation unit `annex-19-3-4-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.4.
updated: '2026-04-13'
---
...
## Basis
3.4.
Pressure required to produce a push rod stroke of 15 mm (p15) based on ThA – f(p) or
declared value. 2/, 4/

## Authority
- clause_path: annex-19-3-4-3
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-19-3-4-3
- source_url: n/a
- confidence: medium
