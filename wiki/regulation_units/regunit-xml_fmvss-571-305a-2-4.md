...
basis: (2) Adjust the voltage of the DC power supply so that the current flow becomes
  more than 0.2 Amperes.
browse_buckets: []
clause_path: 2-4
comparison_key: ad9f79df0ad4796e7334ec218d0b59669dde5f9a
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-305a-2-4
...
phase: post_crash
primary_topic: 2-adjust-the-voltage-of-the-dc-power-supply-so-that-the-current-flow-becomes-mor
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-305a / 2-4
source_collection: xml_fmvss
source_url: null
statement: (2) Adjust the voltage of the DC power supply so that the current flow
  becomes more than 0.2 Amperes.
status: draft
subject: null
summary: Regulation unit `2-4` from xml_fmvss-571-305a.
title: (2) Adjust the voltage of the DC power supply so that the current flow becomes
  more than 0.2 Amperes.
updated: '2026-04-13'
---
