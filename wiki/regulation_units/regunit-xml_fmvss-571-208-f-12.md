...
basis: (f) Wait 10 seconds, then check whether the air bag is deactivated.
browse_buckets:
- occupant_restraints
clause_path: f-12
comparison_key: db527f87fb3e4e7da5e2a8753f2280fddd4ca1ca
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-f-12
...
- airbags
sectno: null
source_citation: xml_fmvss-571-208 / f-12
source_collection: xml_fmvss
source_url: null
statement: (f) Wait 10 seconds, then check whether the air bag is deactivated.
status: draft
subject: null
summary: Regulation unit `f-12` from xml_fmvss-571-208.
title: (f) Wait 10 seconds, then check whether the air bag is deactivated.
updated: '2026-04-13'
---
