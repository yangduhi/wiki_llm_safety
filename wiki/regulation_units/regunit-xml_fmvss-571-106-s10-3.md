---
aliases: []
basis: S10.3 Ozone resistance test. Conduct the test specified in S6.8 using vacuum
  brake hose.
browse_buckets: []
clause_path: s10-3
confidence: medium
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-106-s10-3
jurisdiction: US
...
source_hashes:
  raw/collections/xml_fmvss/571.106.xml: d65d321084536dd5193418028d4c0dc7e9cd222aa4dac14dfeb8fc93d7b9e5d4
source_url: null
statement: S10.3 Ozone resistance test. Conduct the test specified in S6.8 using vacuum
  brake hose.
status: draft
summary: Regulation unit `s10-3` from xml_fmvss-571-106.
title: S10.3 Ozone resistance test. Conduct the test specified in S6.8 using vacuum
  brake hose.
updated: '2026-04-13'
---
