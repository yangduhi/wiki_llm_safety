...
basis: (d) Data obtained from Test No. 1 should be used when conducting Test No. 2.
browse_buckets:
- glazing_retention
clause_path: d-4
comparison_key: 361bbba965cb29af53c39900003c4c5bfdffe740
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-205-a-d-4
...
- glazing
sectno: null
source_citation: xml_fmvss-571-205-a / d-4
source_collection: xml_fmvss
source_url: null
statement: (d) Data obtained from Test No. 1 should be used when conducting Test No.
  2.
status: draft
subject: null
summary: Regulation unit `d-4` from xml_fmvss-571-205-a.
title: (d) Data obtained from Test No. 1 should be used when conducting Test No. 2.
updated: '2026-04-13'
---
