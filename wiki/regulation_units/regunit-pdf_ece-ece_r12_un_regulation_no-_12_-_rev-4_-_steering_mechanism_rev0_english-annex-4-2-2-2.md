...
basis: '2.2.2.
  ...
  If the vehicle is equipped with a device to adjust the slope and position of the

  steering wheel, the test shall be performed with the latter in the normal

  position of use indicated by the manufacturer and regarded by the laboratory
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english-annex-4-2-2-2
...
status: draft
subject: null
summary: Regulation unit `annex-4-2-2-2` from pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english.
title: 2.2.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r12_un_regulation_no-_12_-_rev-4_-_steering_mechanism_rev0_english / annex-4-2-2-2
- source_url: n/a
- confidence: medium
