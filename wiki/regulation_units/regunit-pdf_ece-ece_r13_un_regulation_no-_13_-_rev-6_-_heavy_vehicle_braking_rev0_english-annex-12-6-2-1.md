...
basis: '6.2.1.
  ...
  In the case when an overload protector is neither fitted nor intended to be fitted
  within

  the inertia (overrun) braking system, the wheel brake shall be tested with the

  following test forces or pressures:

  PT = 1.8 P* or pT = 1.8 p* and MT = 1.8 M* as appropriate.'
browse_buckets: []
clause_path: annex-12-6-2-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-12-6-2-1
...
status: draft
subject: null
summary: Regulation unit `annex-12-6-2-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 6.2.1.
updated: '2026-04-13'
---
...
## Basis
6.2.1.
In the case when an overload protector is neither fitted nor intended to be fitted within
the inertia (overrun) braking system, the wheel brake shall be tested with the
following test forces or pressures:
PT = 1.8 P* or pT = 1.8 p* and MT = 1.8 M* as appropriate.
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-12-6-2-1
- source_url: n/a
- confidence: medium
