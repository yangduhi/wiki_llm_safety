...
basis: (1) The high voltage source (AC or DC) meets the protection degree IPXXB when
  tested according to the procedure specified in S9.1 using the IPXXB test probe shown
  in Figures 7a and 7b;
browse_buckets: []
clause_path: 1-2
comparison_key: 0f388bb8e27e4601f33eb40e2711d2c29176353a
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305-1-2
...
sectno: null
source_citation: xml_fmvss-571-305 / 1-2
source_collection: xml_fmvss
source_url: null
statement: (1) The high voltage source (AC or DC) meets the protection degree IPXXB
  when tested according to the procedure specified in S9.1 using the IPXXB test probe
  shown in Figures 7a and 7b;
status: draft
subject: null
summary: Regulation unit `1-2` from xml_fmvss-571-305.
title: (1) The high voltage source (AC or DC) meets the protection degree IPXXB when
  tested according to the procedure specifie
updated: '2026-04-13'
---

# (1) The high voltage source (AC or DC) meets the protection degree IPXXB when tested according to the procedure specifie
