...
basis: (j) Measure and set the dummy's pelvic angle using the pelvic angle gauge.
...
- head_impact
clause_path: j
comparison_key: 1b6f14c3d4ee1deceb0822870b8d905ebf4eee2c
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-214-j
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-214 / j
source_collection: xml_fmvss
source_url: null
statement: (j) Measure and set the dummy's pelvic angle using the pelvic angle gauge.
  The angle is set to 20.0 degrees ±2.5 degrees. If this is not possible, adjust the
  pelvic angle as close to 20.0 degrees as possible while keeping the transverse instrumentation
  platform of the head as level as possible, as specified in S12.3.4(h).
status: draft
subject: null
summary: Regulation unit `j` from xml_fmvss-571-214.
title: (j) Measure and set the dummy's pelvic angle using the pelvic angle gauge.
  The angle is set to 20.0 degrees ±2.5 degrees
updated: '2026-04-13'
---

# (j) Measure and set the dummy's pelvic angle using the pelvic angle gauge. The angle is set to 20.0 degrees ±2.5 degrees
