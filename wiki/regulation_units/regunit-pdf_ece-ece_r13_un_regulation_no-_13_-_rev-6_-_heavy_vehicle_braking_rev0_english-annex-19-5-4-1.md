...
basis: '5.4.1.
  ...
  The following tests shall be conducted by the Technical Service on the vehicle(s)

  defined in paragraph 5.3. of this annex for each ABS configuration taking into

  consideration the application list defined in paragraph 2.1. of Appendix 5 to this

  annex. However, worst case cross referencing may eliminate certain tests. If

  worst case testing is actually used, this should be stated in the test report.'
browse_buckets:
- side_impact
clause_path: annex-19-5-4-1
comparison_key: 9b9ce54227b3dee22e896ca80ac7ca5d07762971
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-19-5-4-1
...
status: draft
subject: null
summary: Regulation unit `annex-19-5-4-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.4.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-19-5-4-1
- source_url: n/a
- confidence: medium
