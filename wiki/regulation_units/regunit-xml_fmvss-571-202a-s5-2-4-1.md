...
basis: 'S5.2.4.1 Procedure using a 165 mm sphere.

  Demonstrate compliance with S4.2.4.1 of this section in accordance with the procedures
  of S5.2.4.1 (a) through (c) of this section, with the head restraint adjusted to
  its lowest height position and any backset position, except as allowed by S4.4.'
browse_buckets:
- head_impact
clause_path: s5-2-4-1
comparison_key: f55b1c2e34210bbf2a92c9651d8a7481f283dab7
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-202a-s5-2-4-1
...
phase: cross_phase
primary_topic: s5-2-4-1-procedure-using-a-165-mm-sphere
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-202a / s5-2-4-1
source_collection: xml_fmvss
source_url: null
statement: S5.2.4.1 Procedure using a 165 mm sphere.
status: draft
subject: null
summary: Regulation unit `s5-2-4-1` from xml_fmvss-571-202a.
title: S5.2.4.1 Procedure using a 165 mm sphere.
updated: '2026-04-13'
---
