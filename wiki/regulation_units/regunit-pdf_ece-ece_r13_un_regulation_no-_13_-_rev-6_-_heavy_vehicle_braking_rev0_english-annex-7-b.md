...
basis: '(b)
  ...
  The signal may be activated when the service braking system is applied at

  a speed above 50 km/h and the antilock system is fully cycling (as defined

  in paragraph 2. of Annex 13).
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-b
...
status: draft
subject: null
summary: Regulation unit `annex-7-b` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-b
- source_url: n/a
- confidence: medium
