...
basis: S7.1.3 In meeting the requirements of S6.1 through S6.4, if the vehicle has
  ...
  has any high pressure electric shutoff valve that is normally open when the electrical
  system is activated, it is open at the time of the barrier crash. Furthermore, if
  any electric shutoff valve prevents sensing of system pressure by the pressure transducer
  when closed, it must be open for both the initial pressure measurement and the pressure
...
# S7.1.3 In meeting the requirements of S6.1 through S6.4, if the vehicle has an electrically driven fuel pump that normal
