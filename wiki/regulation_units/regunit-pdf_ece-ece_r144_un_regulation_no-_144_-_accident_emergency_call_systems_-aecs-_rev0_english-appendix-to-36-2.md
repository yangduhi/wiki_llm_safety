...
basis: '36.2.
  ...
  Notice of confirmation, extension, or refusal of approval shall be

  communicated by the procedure specified in paragraph 34.3. above, to the

  Contracting Parties to the Agreement which apply this Regulation. In

  addition, the index to the information documents and to the test reports,

  attached to the communication document of Annex 4 to this Regulation, shall

  E/ECE/TRANS/505/Rev.3/Add.143

  be amended accordingly to show the date of the most recent revision or

  extension.'
browse_buckets: []
clause_path: appendix-to-36-2
comparison_key: 10a56b291d21d4f5d9e08bc4b9fb197d4a5e42ed
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-appendix-to-36-2
...
status: draft
subject: null
summary: Regulation unit `appendix-to-36-2` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: 36.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / appendix-to-36-2
- source_url: n/a
- confidence: medium
