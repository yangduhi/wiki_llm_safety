...
basis: '6.6.3.7.
  ...
  right hand side and mid-line) are NOT within the 10 mm requirement, then

  the raw data should be reviewed to determine the causes of such large

  variation. In this case the individual test house will determine which

  accelerometer data should be used to determine mobile deformable barrier

  deflection or whether none of the accelerometer readings can be used, in

  which case, the certification test must be repeated. A full explanation should

  be given in the test report.'
browse_buckets:
- side_impact
clause_path: annex-5-6-6-3-7
comparison_key: 2d0fc0c80a7b15e3109ea8e6e2238c04deb6dde8
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english-annex-5-6-6-3-7
...
status: draft
subject: null
summary: Regulation unit `annex-5-6-6-3-7` from pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english.
title: 6.6.3.7.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english / annex-5-6-6-3-7
- source_url: n/a
- confidence: medium
