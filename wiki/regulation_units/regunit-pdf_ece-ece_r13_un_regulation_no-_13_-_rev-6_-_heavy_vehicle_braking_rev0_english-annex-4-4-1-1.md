...
basis: '4.1.1.
  ...
  In an emergency manoeuvre, the time elapsing between the moment when the

  control device begins to be actuated and the moment when the braking force on

  the least favourably placed axle reaches the level corresponding to the prescribed

  performance shall not exceed 0.6 seconds.'
browse_buckets: []
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-4-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-4-4-1-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 4.1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-4-1-1
- source_url: n/a
- confidence: medium
