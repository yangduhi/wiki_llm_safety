...
basis: '(b)
  ...
  Meeting the requirements of this Regulation and fitted to an ISOFIX

  anchorage system and ISOFIX top tether anchorages or vehicle floor contact

  surface meeting the requirements of Regulation No. 14.

  An "Anti-rotation device" for a "Specific vehicle ISOFIX" Child Restraint

  System may comprise a top tether, a support-leg or any other means capable

  of limiting the rotation.'
browse_buckets:
- child_restraints
clause_path: appendix-4-b-2
comparison_key: ecda115ea9dc4f4cfde5ecdee50e11da7e50e503
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-appendix-4-b-2
...
status: draft
subject: null
summary: Regulation unit `appendix-4-b-2` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / appendix-4-b-2
- source_url: n/a
- confidence: medium
