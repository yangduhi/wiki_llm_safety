...
basis: '2.9.
  ...
  upper arm and the torso arm reference line on each side shall be 40° ± 5°.

  The torso arm reference line is defined as the intersection of the plane

  tangential to the front surface of the ribs and the longitudinal vertical plane
  of

  the dummy containing the arm.'
browse_buckets:
- side_impact
- seat_systems
clause_path: annex-7-2-9
comparison_key: 4e50e748228743394820769a4e0a4e33dcbd69f9
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english-annex-7-2-9
...
status: draft
subject: null
summary: Regulation unit `annex-7-2-9` from pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english.
title: 2.9.
updated: '2026-04-13'
---
...
upper arm and the torso arm reference line on each side shall be 40° ± 5°.
The torso arm reference line is defined as the intersection of the plane
tangential to the front surface of the ribs and the longitudinal vertical plane of
the dummy containing the arm.

## Authority
- clause_path: annex-7-2-9
- source_file: raw/collections/pdf_ece/ECE_R95_UN_Regulation_No._95_-_Rev.2_-_Lateral_collision_protection_Rev0_English.pdf
- source_citation: pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english / annex-7-2-9
- source_url: n/a
- confidence: medium
