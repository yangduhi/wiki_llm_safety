...
basis: '(1) “Child restraints could be recalled for safety reasons. You must register
  ...
  1-888-327-4236 (TTY: 1-800-424-9153), or go to www.NHTSA.gov. ”'
browse_buckets: []
clause_path: 1-11
comparison_key: 64bc7efd0ac2097e5dc79bed1da24ba67fb9537f
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-213-1-11
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / 1-11
source_collection: xml_fmvss
source_url: null
statement: '(1) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. Send your name, address, email address
  if available (preceding four words are optional), and the restraint''s model number
  and manufacturing date to ( insert address ) or call ( insert a U.S. telephone number
  ). For recall information, call the U.S. Government''s Vehicle Safety Hotline at
...
status: draft
subject: null
summary: Regulation unit `1-11` from xml_fmvss-571-213.
title: '(1) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. '
updated: '2026-04-13'
---

# (1) “Child restraints could be recalled for safety reasons. You must register this restraint to be reached in a recall. 
