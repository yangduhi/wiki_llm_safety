...
basis: '1.2.1.1.
  ...
  After eight full-stroke actuations of the service braking system control, it shall
  still

  be possible to achieve, on the ninth application, the performance prescribed for
  the

  secondary braking system.'
browse_buckets: []
clause_path: annex-7-1-2-1-1-2
comparison_key: f28c936f5eded422acf11e68057c1ccab60f4741
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-1-2-1-1-2
...
status: draft
subject: null
summary: Regulation unit `annex-7-1-2-1-1-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.2.1.1.
updated: '2026-04-13'
---
...
## Basis
1.2.1.1.
After eight full-stroke actuations of the service braking system control, it shall still
be possible to achieve, on the ninth application, the performance prescribed for the
secondary braking system.

## Authority
- clause_path: annex-7-1-2-1-1-2
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-1-2-1-1-2
- source_url: n/a
- confidence: medium
