---
aliases: []
basis: S7.7.4 Non-service brake type parking brake systems. For vehicles with parking
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-105-s7-7-4
jurisdiction: US
...
page_start: null
phase: cross_phase
primary_topic: service-brake-type
provenance:
...
source_hashes:
  raw/collections/xml_fmvss/571.105.xml: 624b2aa080e310d3d805c34b311d60726267496c1ea71903dc6fca78d1b2e23f
source_url: null
statement: S7.7.4 Non-service brake type parking brake systems. For vehicles with
  parking brake systems not utilizing the service brake friction elements, burnish
  the friction elements of such systems prior to parking brake tests according to
  the manufacturer's published recommendations as furnished to the purchaser. If no
  recommendations are furnished, run the vehicle in an unburnished condition.
status: draft
summary: Regulation unit `s7-7-4` from xml_fmvss-571-105.
title: S7.7.4 Non-service brake type parking brake systems. For vehicles with parking
  brake systems not utilizing the service b
updated: '2026-04-13'
---

# S7.7.4 Non-service brake type parking brake systems. For vehicles with parking brake systems not utilizing the service b
