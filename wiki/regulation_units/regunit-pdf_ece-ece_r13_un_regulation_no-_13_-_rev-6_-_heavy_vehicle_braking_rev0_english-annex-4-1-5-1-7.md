...
basis: '1.5.1.7.
  ...
  In the case of vehicles equipped with automatic brake adjustment devices the

  adjustment of the brakes shall, prior to the Type-I test above, be set according
  to
  ...
  page 71'
browse_buckets: []
clause_path: annex-4-1-5-1-7
comparison_key: 4da10a1e6bab8e7a54f1b21043260d1e5f3cedee
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-1-5-1-7
...
status: draft
subject: null
summary: Regulation unit `annex-4-1-5-1-7` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.5.1.7.
updated: '2026-04-13'
---
...
1.5.1.7.
In the case of vehicles equipped with automatic brake adjustment devices the
adjustment of the brakes shall, prior to the Type-I test above, be set according to
the following procedures as appropriate:
E/ECE/324
E/ECE/TRANS/505 } Rev.1/Add.12/Rev.6
Regulation No. 13
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-1-5-1-7
- source_url: n/a
- confidence: medium
