...
basis: (1) Parallel to the SORL, in the case of the add-on child restraint system,
  or
browse_buckets:
- child_restraints
clause_path: 1-2
comparison_key: f83c2cee3bb4fb0a923cd94e7316666f3d2d48cb
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-1-2
...
phase: cross_phase
primary_topic: 1-parallel-to-the-sorl-in-the-case-of-the-add-on-child-restraint-system-or
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / 1-2
source_collection: xml_fmvss
source_url: null
statement: (1) Parallel to the SORL, in the case of the add-on child restraint system,
  or
status: draft
subject: null
summary: Regulation unit `1-2` from xml_fmvss-571-213.
title: (1) Parallel to the SORL, in the case of the add-on child restraint system,
  or
updated: '2026-04-13'
---
