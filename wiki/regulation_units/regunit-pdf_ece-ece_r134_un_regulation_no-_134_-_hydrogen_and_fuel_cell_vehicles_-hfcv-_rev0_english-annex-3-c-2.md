...
basis: '(c)
  ...
  If the measured permeation rate is greater than 0.005 mg/sec (3.6

  Nml/min), a localized leak test is performed to ensure no point of

  localized external leakage is greater than 0.005 mg/sec (3.6 Nml/min)

  (Annex 3, paragraph 4.3. test procedure).'
browse_buckets:
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-3-c-2
...
status: draft
subject: null
summary: Regulation unit `annex-3-c-2` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: (c)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-3-c-2
- source_url: n/a
- confidence: medium
