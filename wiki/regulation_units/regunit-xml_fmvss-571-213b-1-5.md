...
basis: (1) A seating position equipped with a continuous-loop lap/shoulder belt;
browse_buckets:
- child_restraints
- seat_systems
clause_path: 1-5
comparison_key: f7b268fd3c0d2d3057bf2fa5bf5d180071ea179d
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213b-1-5
...
phase: cross_phase
primary_topic: 1-a-seating-position-equipped-with-a-continuous-loop-lap-shoulder-belt
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213b / 1-5
source_collection: xml_fmvss
source_url: null
statement: (1) A seating position equipped with a continuous-loop lap/shoulder belt;
status: draft
subject: null
summary: Regulation unit `1-5` from xml_fmvss-571-213b.
title: (1) A seating position equipped with a continuous-loop lap/shoulder belt;
updated: '2026-04-13'
---
