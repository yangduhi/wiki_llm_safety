...
basis: '2.1.1.3.
  ...
  The blocks must be centred on the six zones defined in Figure 1 and each

  block (including incomplete cells) should cover completely the area defined

  for each zone).'
browse_buckets: []
clause_path: annex-5-2-1-1-3
comparison_key: fad7e47f9dacd41c22f5f6c4c599131e7da3f4f1
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english-annex-5-2-1-1-3
...
status: draft
subject: null
summary: Regulation unit `annex-5-2-1-1-3` from pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english.
title: 2.1.1.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english / annex-5-2-1-1-3
- source_url: n/a
- confidence: medium
