...
basis: (b) The upper arms are parallel to the torso and the hands are next to where
  the thighs would be.
browse_buckets:
- occupant_restraints
clause_path: b-120
comparison_key: fa509404f28494fc764104c856b3bc04a9045e0a
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-b-120
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / b-120
source_collection: xml_fmvss
source_url: null
statement: (b) The upper arms are parallel to the torso and the hands are next to
  where the thighs would be.
status: draft
subject: null
summary: Regulation unit `b-120` from xml_fmvss-571-208.
title: (b) The upper arms are parallel to the torso and the hands are next to where
  the thighs would be.
updated: '2026-04-13'
---
