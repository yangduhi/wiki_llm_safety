...
basis: (f) Determine conformance with the requirements in S5.1.
browse_buckets:
- child_restraints
clause_path: f-5
comparison_key: 1778b5baaa239f53d653846ce2b4bbeafacfa2fc
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-f-5
...
phase: cross_phase
primary_topic: f-determine-conformance-with-the-requirements-in-s5-1
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / f-5
source_collection: xml_fmvss
source_url: null
statement: (f) Determine conformance with the requirements in S5.1.
status: draft
subject: null
summary: Regulation unit `f-5` from xml_fmvss-571-213.
title: (f) Determine conformance with the requirements in S5.1.
updated: '2026-04-13'
---
