...
basis: '5.2.4.
  ...
  Chemical exposure and ambient-temperature pressure cycling test

  The storage container is exposed to chemicals found in the on-road

  environment and pressure cycled to 125 per cent NWP (+2/-0 MPa) at 20

  (±5) °C for 60 per cent number of Cycles pressure cycles (Annex 3,

  paragraph 3.4. test procedure). Chemical exposure is discontinued before the

  last 10 cycles, which are conducted to 150 per cent NWP (+2/-0 MPa).'
browse_buckets:
- fuel_system_integrity
clause_path: annex-3-5-2-4-2
comparison_key: ad44616d9c033268800546087d07a7f7c57c16bd
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-3-5-2-4-2
...
status: draft
subject: null
summary: Regulation unit `annex-3-5-2-4-2` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: 5.2.4.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-3-5-2-4-2
- source_url: n/a
- confidence: medium
