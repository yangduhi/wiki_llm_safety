...
attachment_section: Annex 8 – Appendix 2
basis: '1.2.

  Apply a load of 150 N, on a 40 mm diameter flat faced plunger, horizontally,

  in a direction perpendicular to the manikin''s superior-inferior axis. The axis

  of the plunger should be in the centre of the manikin''s shoulder and adjacent

  to point A on the shoulder (see Figure 2). The lateral deflection of the

  plunger from the point of first contact with the arm should be between 30 mm

  and 50 mm.'
browse_buckets:
- child_restraints
clause_path: annex-8-1-2-3
comparison_key: 7133dff1fa317e324a0c9b9312819d2c35026ec8
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english-annex-8-1-2-3
...
status: draft
subject: null
summary: Regulation unit `annex-8-1-2-3` from pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english.
title: 1.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english / annex-8-1-2-3
- source_url: n/a
- confidence: medium
