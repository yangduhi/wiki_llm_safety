...
basis: (h) Wait ten seconds, then check whether the air bag is deactivated.
browse_buckets:
- occupant_restraints
clause_path: h-7
comparison_key: 1e7c6bf7e8bc713ad79d7e6f52b38091a7b5c5d2
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-h-7
...
- airbags
sectno: null
source_citation: xml_fmvss-571-208 / h-7
source_collection: xml_fmvss
source_url: null
statement: (h) Wait ten seconds, then check whether the air bag is deactivated.
status: draft
subject: null
summary: Regulation unit `h-7` from xml_fmvss-571-208.
title: (h) Wait ten seconds, then check whether the air bag is deactivated.
updated: '2026-04-13'
---
