...
basis: '4) 작동상태에 있는 자동차로유지기능은 다음과 같이 자동차의 속도를 제어할

  수 있을 것'
browse_buckets: []
clause_path: 4-243
comparison_key: 37302f05909a6e50bc3bf4065c08f5b91584a210
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-4-243
...
parent_title: 4) 작동상태에 있는 자동차로유지기능은 다음과 같이 자동차의 속도를 제어할
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 4-243
source_collection: xml_kmvss
source_url: null
statement: 4) 작동상태에 있는 자동차로유지기능은 다음과 같이 자동차의 속도를 제어할
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `4-243` from xml_kmvss-kmvss_att_0027_128.
title: 4) 작동상태에 있는 자동차로유지기능은 다음과 같이 자동차의 속도를 제어할
updated: '2026-04-13'
---

# 4) 작동상태에 있는 자동차로유지기능은 다음과 같이 자동차의 속도를 제어할
