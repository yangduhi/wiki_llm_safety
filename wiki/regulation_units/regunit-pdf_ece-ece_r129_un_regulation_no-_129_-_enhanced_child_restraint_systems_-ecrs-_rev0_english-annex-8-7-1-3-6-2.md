...
basis: '7.1.3.6.2.
  ...
  If the i-Size Child Restraint System uses a top tether, one test shall be carried

  out with the smallest dummy with the shorter distance of the top tether

  (anchorage point G1). A second test shall be carried out with the heavier

  dummy with the longer distance of the top tether (anchorage point G2).

  Adjust the top tether to achieve a tension load of 50  5 N. For side lateral

  impact the ISOFIX child restraint shall be tested with only the shorter

  distance of the top tether.'
browse_buckets:
- side_impact
- child_restraints
clause_path: annex-8-7-1-3-6-2
comparison_key: 4b0b48c3a1a4d480b2a4a792ced8cdc716eaa761
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-8-7-1-3-6-2
...
status: draft
subject: null
summary: Regulation unit `annex-8-7-1-3-6-2` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 7.1.3.6.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-8-7-1-3-6-2
- source_url: n/a
- confidence: medium
