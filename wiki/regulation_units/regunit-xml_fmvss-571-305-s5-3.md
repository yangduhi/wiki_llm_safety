...
basis: 'S5.3 Electrical safety. After each test specified in S6 of this standard,
  each high voltage source in a vehicle must meet one of the following requirements:
  electrical isolation requirements of subparagraph (a), the voltage level requirements
  of subparagraph (b), or the physical barrier protection requirements of subparagraph
  (c).'
browse_buckets: []
clause_path: s5-3
comparison_key: 47f28a162a3e8ff391878c75fad552f53eda8f35
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305-s5-3
...
sectno: null
source_citation: xml_fmvss-571-305 / s5-3
source_collection: xml_fmvss
source_url: null
statement: 'S5.3 Electrical safety. After each test specified in S6 of this standard,
  each high voltage source in a vehicle must meet one of the following requirements:
  electrical isolation requirements of subparagraph (a), the voltage level requirements
  of subparagraph (b), or the physical barrier protection requirements of subparagraph
  (c).'
status: draft
subject: null
summary: Regulation unit `s5-3` from xml_fmvss-571-305.
title: S5.3 Electrical safety. After each test specified in S6 of this standard, each
  high voltage source in a vehicle must mee
updated: '2026-04-13'
---

# S5.3 Electrical safety. After each test specified in S6 of this standard, each high voltage source in a vehicle must mee
