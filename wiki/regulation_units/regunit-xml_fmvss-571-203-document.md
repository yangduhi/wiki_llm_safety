...
basis: § 571.203 Standard No. 203; Impact protection for the driver from the steering
  control system.
browse_buckets:
- steering_control
clause_path: document
comparison_key: 33f9cd0bde9112652b7f170ffc2e84fea0ea4759
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-203-document
...
phase: cross_phase
primary_topic: 571-203-standard-no-203-impact-protection-for-the-driver-from-the-steering-contr
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-203 / document
source_collection: xml_fmvss
source_url: null
statement: § 571.203 Standard No. 203; Impact protection for the driver from the steering
  control system.
status: draft
subject: null
summary: Regulation unit `document` from xml_fmvss-571-203.
