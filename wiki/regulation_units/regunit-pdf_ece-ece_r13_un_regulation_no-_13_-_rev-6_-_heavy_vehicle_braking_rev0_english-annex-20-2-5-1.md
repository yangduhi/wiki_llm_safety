...
basis: '2.5.1.
  ...
  "Control transmission" means the combination of the components of the

  transmission which control the operation of the brakes, including the control

  function and the necessary reserve(s) of energy.'
browse_buckets: []
clause_path: annex-20-2-5-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-20-2-5-1
...
status: draft
subject: null
summary: Regulation unit `annex-20-2-5-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.5.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-20-2-5-1
- source_url: n/a
- confidence: medium
