...
basis: '(3) When calculating Nij using equation S15.3.6(a)(4), the critical values,
  Fzc and Myc, are:'
browse_buckets:
- occupant_restraints
clause_path: 3-19
comparison_key: 55bfcc5050985c8d4eb26e26765236b18fcb0df4
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-3-19
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / 3-19
source_collection: xml_fmvss
source_url: null
statement: '(3) When calculating Nij using equation S15.3.6(a)(4), the critical values,
  Fzc and Myc, are:'
status: draft
subject: null
summary: Regulation unit `3-19` from xml_fmvss-571-208.
title: '(3) When calculating Nij using equation S15.3.6(a)(4), the critical values,
  Fzc and Myc, are:'
updated: '2026-04-13'
---
