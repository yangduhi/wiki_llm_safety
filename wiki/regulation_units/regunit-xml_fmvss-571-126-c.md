...
basis: '(c) For purposes of complying with S8.3, a manufacturer may count a vehicle
  if it:'
browse_buckets: []
clause_path: c
comparison_key: 3d5c959adf5356273c1ddbb8d17f04fdf0ba4341
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-126-c
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-126 / c
source_collection: xml_fmvss
source_url: null
statement: '(c) For purposes of complying with S8.3, a manufacturer may count a vehicle
  if it:'
status: draft
subject: null
summary: Regulation unit `c` from xml_fmvss-571-126.
title: '(c) For purposes of complying with S8.3, a manufacturer may count a vehicle
  if it:'
updated: '2026-04-13'
---
