...
basis: '(a) Prepare the dummy. (1) When using the Hybrid III 10-year-old dummy, prepare
  the dummy according to the following:'
browse_buckets:
- child_restraints
clause_path: a-31
comparison_key: a8cffdeba0ffd20e21562517d074bc4f519e420e
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-a-31
...
phase: cross_phase
primary_topic: a-prepare-the-dummy-1-when-using-the-hybrid-iii-10-year-old-dummy-prepare-the-du
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / a-31
source_collection: xml_fmvss
source_url: null
statement: '(a) Prepare the dummy. (1) When using the Hybrid III 10-year-old dummy,
  prepare the dummy according to the following:'
status: draft
subject: null
summary: Regulation unit `a-31` from xml_fmvss-571-213.
title: '(a) Prepare the dummy. (1) When using the Hybrid III 10-year-old dummy, prepare
  the dummy according to the following:'
updated: '2026-04-13'
---
