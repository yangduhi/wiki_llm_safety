...
basis: '(c)
  ...
  The position and if necessary the routing of top tethers, or other means

  of limiting Child Restraint System rotation requiring action by the

  user, shall be indicated using one of the following symbols as

  appropriate;'
browse_buckets:
- child_restraints
clause_path: annex-20-c
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-20-c
...
status: draft
subject: null
summary: Regulation unit `annex-20-c` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: (c)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-20-c
- source_url: n/a
- confidence: medium
