...
basis: '5.3.5.
  ...
  Verification test for expected on-road performance (sequential pneumatic tests)

  Proof pressure test

  Ambient and extreme temperature gas pressure cycling test (pneumatic)

  Extreme temperature static gas pressure leak/permeation test (pneumatic)

  Residual proof pressure test

  Residual strength burst test (hydraulic)'
browse_buckets:
- fuel_system_integrity
clause_path: annex-3-5-3-5
comparison_key: c57662811280b8ccba7b13ca45cb182a398c8895
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-3-5-3-5
...
status: draft
subject: null
summary: Regulation unit `annex-3-5-3-5` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: 5.3.5.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-3-5-3-5
- source_url: n/a
- confidence: medium
