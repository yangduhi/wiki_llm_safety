...
basis: S6.3.5.1 The control trailer is an unbraked, flatbed semi-trailer that has
  ...
  measured from the transverse centerline of the axle to the centerline of the kingpin
  (the point where the trailer attaches to the truck tractor). At the manufacturer's
  option, truck tractors with four or more axles may use a control trailer with a
  length of more than 7,010 mm (276 inches), but no more than 13,208 mm (520 inches)
...
statement: S6.3.5.1 The control trailer is an unbraked, flatbed semi-trailer that
  ...
  a length of at least 6,400 mm (252 inches), but no more than 7,010 mm (276 inches),
  when measured from the transverse centerline of the axle to the centerline of the
  kingpin (the point where the trailer attaches to the truck tractor). At the manufacturer's
  option, truck tractors with four or more axles may use a control trailer with a
  length of more than 7,010 mm (276 inches), but no more than 13,208 mm (520 inches)
  when measured from the transverse centerline of the axle to the centerline of the
  kingpin.
...
# S6.3.5.1 The control trailer is an unbraked, flatbed semi-trailer that has a single axle with a GAWR of 8,165 kg (18,000
