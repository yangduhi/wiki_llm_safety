...
basis: (d) Repeat the process on the outside surface of the window.
browse_buckets:
- side_impact
- anti_ejection
clause_path: d
comparison_key: 38abf5b67665716b35f88a000b8d1806b62bdbf7
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-226-d
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-226 / d
source_collection: xml_fmvss
source_url: null
statement: (d) Repeat the process on the outside surface of the window.
status: draft
subject: null
summary: Regulation unit `d` from xml_fmvss-571-226.
title: (d) Repeat the process on the outside surface of the window.
updated: '2026-04-13'
---
