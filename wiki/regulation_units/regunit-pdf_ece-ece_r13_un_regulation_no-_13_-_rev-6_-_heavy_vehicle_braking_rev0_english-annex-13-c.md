...
basis: '(c)
  ...
  axle load and tyres (different loads and different tyres have to be tested and the

  results shown to the Technical Service which will decide if they are representative
  for the

  vehicle to be approved).'
browse_buckets: []
clause_path: annex-13-c
comparison_key: c7f2b96336ad075f4eebae7b8df9a981ddec8591
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-c
...
status: draft
subject: null
summary: Regulation unit `annex-13-c` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (c)
updated: '2026-04-13'
---
...
(c)
axle load and tyres (different loads and different tyres have to be tested and the
results shown to the Technical Service which will decide if they are representative for the
vehicle to be approved).

## Authority
- clause_path: annex-13-c
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-c
- source_url: n/a
- confidence: medium
