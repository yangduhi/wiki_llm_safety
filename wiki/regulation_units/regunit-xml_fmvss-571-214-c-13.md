...
basis: (c) Legs. The upper legs of each test dummy rest against the seat cushion to
  the extent permitted by placement of the feet. The initial distance between the
  outboard knee clevis flange surfaces is 292 mm (11.5 inches). To the extent practicable,
  both legs of the test dummies in outboard passenger positions are in vertical longitudinal
  planes. Final adjustment to accommodate placement of feet in accordance with S12.1.2(d)
...
- seat_systems
clause_path: c-13
comparison_key: e2d078671aad31702fa1de063cdb32e4b890cae3
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-214-c-13
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-214 / c-13
source_collection: xml_fmvss
source_url: null
statement: (c) Legs. The upper legs of each test dummy rest against the seat cushion
  to the extent permitted by placement of the feet. The initial distance between the
  outboard knee clevis flange surfaces is 292 mm (11.5 inches). To the extent practicable,
  both legs of the test dummies in outboard passenger positions are in vertical longitudinal
  planes. Final adjustment to accommodate placement of feet in accordance with S12.1.2(d)
  for various passenger compartment configurations is permitted.
status: draft
subject: null
summary: Regulation unit `c-13` from xml_fmvss-571-214.
title: (c) Legs. The upper legs of each test dummy rest against the seat cushion to
  the extent permitted by placement of the fe
updated: '2026-04-13'
---

# (c) Legs. The upper legs of each test dummy rest against the seat cushion to the extent permitted by placement of the fe
