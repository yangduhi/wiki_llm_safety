...
basis: 'S4 Definitions.
  ...
  Ackerman Steer Angle means the angle whose tangent is the wheelbase divided by the
...
browse_buckets: []
clause_path: s4
comparison_key: fed3dcd75001ff2a1bfe87ea43ce7f244283ffc1
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-136-s4
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-136 / s4
source_collection: xml_fmvss
source_url: null
statement: S4 Definitions.
status: draft
subject: null
summary: Regulation unit `s4` from xml_fmvss-571-136.
