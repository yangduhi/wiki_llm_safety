...
basis: '6.2.3.
  ...
  It shall not be possible to remove or detach without the use of specific tools,

  any components not designed to be removable or detachable. Any

  components that are designed to be removable for maintenance or adjustment

  E/ECE/324/Rev.2/Add.128

  E/ECE/TRANS/505/Rev.2/Add.128

  purpose shall be so designed as to avoid any risk of incorrect assembly and

  use, as the assembly and disassembly processes shall be explained in detail in

  the restraint user guides. Any harness belt shall be capable of its full range of

  adjustment without disassembly.'
browse_buckets:
- child_restraints
clause_path: annex-3-6-2-3
comparison_key: c08982a665cd0478b60420ce2d7c9b50e08ddf6c
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-3-6-2-3
...
status: draft
subject: null
summary: Regulation unit `annex-3-6-2-3` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 6.2.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-3-6-2-3
- source_url: n/a
- confidence: medium
