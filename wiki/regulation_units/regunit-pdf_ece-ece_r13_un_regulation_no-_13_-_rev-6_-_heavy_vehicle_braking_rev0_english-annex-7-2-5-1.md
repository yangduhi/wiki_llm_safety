...
basis: '2.5.1.
  ...
  If the power-driven vehicle is equipped with one or more energy storage devices

  for auxiliary equipment having a total capacity exceeding 20 per cent of the total

  capacity of the braking energy storage devices, an additional test shall be

  performed during which no irregularity shall occur in the operation of the valves

  controlling the filling of the energy storage device(s) for auxiliary equipment.'
browse_buckets: []
clause_path: annex-7-2-5-1
comparison_key: 7c7c56dc7168f8ac9e4392b8948f5e422d7ab299
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-2-5-1
...
status: draft
subject: null
summary: Regulation unit `annex-7-2-5-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.5.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-2-5-1
- source_url: n/a
- confidence: medium
