...
basis: '(i) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. Send your name, address, e-mail address
  if available (preceding four words are optional), and the restraint''s model number
  and manufacturing date to ( insert address ) or call ( insert a U.S. telephone number
  ...
  (ii) “Child restraints could be recalled for safety reasons. You must register this
  restraint to be reached in a recall. Send your name, address, e-mail address if
  available (preceding four words are optional), and the restraint''s model number
  and manufacturing date to ( insert address ) or call ( insert telephone number )
  or register online at ( insert Web site for electronic registration form ). For
  recall information, call the U.S. Government''s Vehicle Safety Hotline at 1-888-327-4236
  (TTY: 1-800-424-9153), or go to http://www.NHTSA.gov. ”'
browse_buckets: []
clause_path: i-12
comparison_key: 15095ac2b177b797e8b609e9ecd2c407477a2bb1
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-213-i-12
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / i-12
source_collection: xml_fmvss
source_url: null
statement: '(i) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. Send your name, address, e-mail address
  if available (preceding four words are optional), and the restraint''s model number
  and manufacturing date to ( insert address ) or call ( insert a U.S. telephone number
  ). For recall information, call the U.S. Government''s Vehicle Safety Hotline at
...
status: draft
subject: null
summary: Regulation unit `i-12` from xml_fmvss-571-213.
title: '(i) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. '
updated: '2026-04-13'
---

# (i) “Child restraints could be recalled for safety reasons. You must register this restraint to be reached in a recall. 
