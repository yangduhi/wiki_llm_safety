...
basis: '가) 부분 자율주행시스템 및 부분 자율시스템을 작동하여 자동차를 운행하게

  하는데 필요한 자동차의 관련 기능ㆍ장치에 고장이 발생한 사실을 감지하

  는 방법'
browse_buckets: []
clause_path: item-861
comparison_key: b063150911c1bfe9322a7888ec89041bb772db6f
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-item-861
...
line_index_end: 865
line_index_start: 861
note_type: regulation_unit
page_end: null
page_start: null
parent_clause_path: 2-859
parent_clause_text: 2) 다음의 방법으로 자가진단을 상시 실시하도록 설계될 것
parent_title: 가) 부분 자율주행시스템 및 부분 자율시스템을 작동하여 자동차를 운행하게
phase: pre_crash
...
row_group_id: group-110
secondary_topics:
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / item-861
source_collection: xml_kmvss
source_url: null
statement: 가) 부분 자율주행시스템 및 부분 자율시스템을 작동하여 자동차를 운행하게
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `item-861` from xml_kmvss-kmvss_att_0027_128.
title: 가) 부분 자율주행시스템 및 부분 자율시스템을 작동하여 자동차를 운행하게
updated: '2026-04-13'
---

# 가) 부분 자율주행시스템 및 부분 자율시스템을 작동하여 자동차를 운행하게
