...
basis: 다) 운전자의 머리 움직임이 주로 운전조작을 하는 방향으로 향하는 상태
browse_buckets: []
clause_path: item-939
comparison_key: 14e09744f99c9d548593f104e55fac32b5f4df76
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-item-939
...
line_index_end: 939
line_index_start: 939
note_type: regulation_unit
page_end: null
page_start: null
parent_clause_path: 2-1-929
parent_clause_text: 2) 위 1)에 따른 주의상태 여부에 대한 감지는 운전자가 다음의 상태에 있는
parent_title: 다) 운전자의 머리 움직임이 주로 운전조작을 하는 방향으로 향하는 상태
phase: pre_crash
...
row_group_id: group-128
secondary_topics:
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / item-939
source_collection: xml_kmvss
source_url: null
statement: 다) 운전자의 머리 움직임이 주로 운전조작을 하는 방향으로 향하는 상태
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `item-939` from xml_kmvss-kmvss_att_0027_128.
title: 다) 운전자의 머리 움직임이 주로 운전조작을 하는 방향으로 향하는 상태
updated: '2026-04-13'
---

# 다) 운전자의 머리 움직임이 주로 운전조작을 하는 방향으로 향하는 상태
