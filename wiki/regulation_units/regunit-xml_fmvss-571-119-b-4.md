...
basis: (b) The tire identification number required by part 574 of this chapter. This
  number may be marked on only one sidewall.
browse_buckets:
- side_impact
clause_path: b-4
comparison_key: c7680cbbf79ae8b398f3142a719a34c1ef57954e
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-119-b-4
...
parent_title: § 571.119 Standard No. 119; New pneumatic tires for motor vehicles with
  ...
  for motorcycles.
phase: cross_phase
primary_topic: b-the-tire-identification-number-required-by-part-574-of-this-chapter-this-numbe
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-119 / b-4
source_collection: xml_fmvss
source_url: null
statement: (b) The tire identification number required by part 574 of this chapter.
  This number may be marked on only one sidewall.
status: draft
subject: null
summary: Regulation unit `b-4` from xml_fmvss-571-119.
title: (b) The tire identification number required by part 574 of this chapter. This
  number may be marked on only one sidewall.
updated: '2026-04-13'
---
