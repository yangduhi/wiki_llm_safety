...
attachment_section: Annex 13 to this Regulation, shall be passed through the lock-off
  and frame
basis: '8.3.2.

  The certification and measuring procedures shall correspond to those

  specified in the latest version of ISO 6487; the measuring equipment shall

  correspond to the specification of a data channel with a channel filter class
  ...
  Place the device vertically on a flat rigid surface. Lower the impact mass

  until it contacts the surface and set the penetration marker to the zero

  position. Place the device vertically above the test point, raise the mass

  500 ± 5 mm and allow it to fall freely to make impact on the seat surface.

  Record the penetration and the deceleration curve.'
browse_buckets:
- child_restraints
- seat_systems
clause_path: annex-13-8-3-2
comparison_key: bbdbee53ac04bb86daef6eb7dc6251aa449f8e25
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english-annex-13-8-3-2
...
status: draft
subject: null
summary: Regulation unit `annex-13-8-3-2` from pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english.
title: 8.3.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english / annex-13-8-3-2
- source_url: n/a
- confidence: medium
