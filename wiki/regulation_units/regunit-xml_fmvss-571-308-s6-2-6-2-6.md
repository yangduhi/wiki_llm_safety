...
basis: S6.2.6.2.6. Vibration test. (a) The valve is pressurized with hydrogen to any
  ...
  orthogonal axes (vertical, lateral and longitudinal) at the most severe resonant
  frequencies.
browse_buckets: []
...
statement: S6.2.6.2.6. Vibration test. (a) The valve is pressurized with hydrogen
  ...
  ends, and vibrated for any duration between 30.0 and 35.0 minutes along each of
...
# S6.2.6.2.6. Vibration test. (a) The valve is pressurized with hydrogen to any pressure between 100.0 percent NWP and 105
