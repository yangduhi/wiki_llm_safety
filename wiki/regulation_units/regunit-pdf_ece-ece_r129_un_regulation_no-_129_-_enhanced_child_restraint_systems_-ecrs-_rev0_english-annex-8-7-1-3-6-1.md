...
attachment_section: Annex 8 to this Regulation.
basis: '7.1.3.6.1.

  If the Child Restraint System is designed for two or more children, one test

  shall be carried out with the heaviest dummies occupying all seating

  positions. A second test with the lightest and the heaviest dummies specified

  above shall be carried out. The tests shall be conducted using the test bench

  as shown in Annex 6, Appendix 3, Figure 3. The laboratory conducting the

  tests may, if it deems it advisable, add a third test with any combination of

  dummies or empty seat positions.'
browse_buckets:
- child_restraints
- seat_systems
clause_path: annex-8-7-1-3-6-1
comparison_key: 86c25909894e48c5ec00d63b3daa78a4e46fca2e
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-8-7-1-3-6-1
...
status: draft
subject: null
summary: Regulation unit `annex-8-7-1-3-6-1` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 7.1.3.6.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-8-7-1-3-6-1
- source_url: n/a
- confidence: medium
