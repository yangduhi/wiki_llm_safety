...
basis: '1.3.1.
  ...
  shall be such that the vacuum level provided at the user points shall not have fallen

  below a level equivalent to one-half of the value obtained at the first brake

  application after a test comprising four full-stroke actuations of the trailer''s
  service

  braking system.'
browse_buckets: []
clause_path: annex-7-1-3-1-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-1-3-1-2
...
status: draft
subject: null
summary: Regulation unit `annex-7-1-3-1-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.3.1.
updated: '2026-04-13'
---
...
shall be such that the vacuum level provided at the user points shall not have fallen
below a level equivalent to one-half of the value obtained at the first brake
application after a test comprising four full-stroke actuations of the trailer's service
braking system.

## Authority
- clause_path: annex-7-1-3-1-2
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-1-3-1-2
- source_url: n/a
- confidence: medium
