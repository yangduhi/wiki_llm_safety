...
basis: '1.3.
  ...
  The response times determined in accordance with the provisions of this annex shall

  be rounded to the nearest tenth of a second. If the figure representing the hundredth
  is

  five or more, the response time shall be rounded up to the next higher tenth.'
browse_buckets: []
clause_path: annex-6-1-3
comparison_key: a41e6fa4af1321c9ac511265b4315fcf5d755bf6
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-6-1-3
...
status: draft
subject: null
summary: Regulation unit `annex-6-1-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.3.
updated: '2026-04-13'
---
...
1.3.
The response times determined in accordance with the provisions of this annex shall
be rounded to the nearest tenth of a second. If the figure representing the hundredth is
five or more, the response time shall be rounded up to the next higher tenth.

## Authority
- clause_path: annex-6-1-3
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-6-1-3
- source_url: n/a
- confidence: medium
