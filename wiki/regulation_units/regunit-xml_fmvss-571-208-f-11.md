...
basis: (f) Start the vehicle engine or place the ignition in the “on” position, whichever
  will turn on the suppression system, and then close all vehicle doors.
browse_buckets:
- occupant_restraints
- door_retention
clause_path: f-11
comparison_key: ff0a64617885ee523057e99a887865fe79bd4f5b
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-f-11
...
- doors
sectno: null
source_citation: xml_fmvss-571-208 / f-11
source_collection: xml_fmvss
source_url: null
statement: (f) Start the vehicle engine or place the ignition in the “on” position,
  whichever will turn on the suppression system, and then close all vehicle doors.
status: draft
subject: null
summary: Regulation unit `f-11` from xml_fmvss-571-208.
title: '(f) Start the vehicle engine or place the ignition in the “on” position, whichever
  will turn on the suppression system, '
updated: '2026-04-13'
---

# (f) Start the vehicle engine or place the ignition in the “on” position, whichever will turn on the suppression system, 
