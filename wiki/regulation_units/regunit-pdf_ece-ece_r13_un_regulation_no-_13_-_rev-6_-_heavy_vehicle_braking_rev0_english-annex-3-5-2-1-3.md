...
basis: '5.2.1.3.
  ...
  Where there are separate controls for the service braking system and the

  secondary braking system, simultaneous actuation of the two controls shall not

  render both the service braking system and the secondary braking system

  inoperative, either when both braking systems are in good working order or when

  one of them is faulty.'
browse_buckets: []
clause_path: annex-3-5-2-1-3
comparison_key: 1b4aaf8637b9e5b5311356b62eb069f7fd7443d8
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-3-5-2-1-3
...
status: draft
subject: null
summary: Regulation unit `annex-3-5-2-1-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.2.1.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-3-5-2-1-3
- source_url: n/a
- confidence: medium
