...
basis: '1) 운전자가 자동차로유지기능을 작동(작동모드)시키고 해제(오프모드)시키는

  수단을 설치할 것. 이 경우 자동차로유지기능의 작동(작동모드) 수단과 해제

  (오프모드) 수단은 같아야 한다.'
browse_buckets: []
clause_path: 1-15
comparison_key: b1cf7901d2869628640e5b2622e1525d32a4fb0e
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-1-15
...
parent_title: 1) 운전자가 자동차로유지기능을 작동(작동모드)시키고 해제(오프모드)시키는
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 1-15
source_collection: xml_kmvss
source_url: null
statement: 1) 운전자가 자동차로유지기능을 작동(작동모드)시키고 해제(오프모드)시키는
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `1-15` from xml_kmvss-kmvss_att_0027_128.
title: 1) 운전자가 자동차로유지기능을 작동(작동모드)시키고 해제(오프모드)시키는
updated: '2026-04-13'
---

# 1) 운전자가 자동차로유지기능을 작동(작동모드)시키고 해제(오프모드)시키는
