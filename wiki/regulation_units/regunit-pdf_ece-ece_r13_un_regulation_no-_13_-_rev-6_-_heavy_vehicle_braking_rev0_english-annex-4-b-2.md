...
basis: '(b) at a level not less than 95 per cent of the full charge level, where the

  manufacturer has made no specific recommendation, or'
browse_buckets: []
clause_path: annex-4-b-2
comparison_key: b1315c031d800720c01ea4a119251c39b7784eb4
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-b-2
...
phase: cross_phase
primary_topic: b-at-a-level-not-less-than-95-per-cent-of-the-full-charge-level-where-the
provenance:
...
source_url: null
statement: (b) at a level not less than 95 per cent of the full charge level, where
  the
status: draft
subject: null
summary: Regulation unit `annex-4-b-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (b) at a level not less than 95 per cent of the full charge level, where the
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-b-2
- source_url: n/a
- confidence: medium
