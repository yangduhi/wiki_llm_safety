---
aliases: []
basis: S5.4.3.3 Electrical isolation of high voltage sources for charging the electric
  energy storage device. For the vehicle charge inlet intended to be conductively
  connected to the AC external electric power supply, the electric isolation between
  the electrical chassis and the high voltage sources that are conductively connected
  to the vehicle charge inlet during charging of the electric energy storage device
  shall be greater than or equal to 500 ohms/volt when the charge connector is disconnected.
  The electrical isolation is measured at the high voltage live parts of the vehicle
  charge inlet and determined in accordance with the procedure specified in S7.6.
...
id: regunit-xml_fmvss-571-305-s5-4-3-3
jurisdiction: US
...
source_hashes:
  raw/collections/xml_fmvss/571.305.xml: 85f00df5cd1bba685626a174940308b18c28e2bf7aa0556207f786b707fcf3b7
source_url: null
statement: S5.4.3.3 Electrical isolation of high voltage sources for charging the
  electric energy storage device. For the vehicle charge inlet intended to be conductively
  connected to the AC external electric power supply, the electric isolation between
  the electrical chassis and the high voltage sources that are conductively connected
  to the vehicle charge inlet during charging of the electric energy storage device
  shall be greater than or equal to 500 ohms/volt when the charge connector is disconnected.
  ...
  During the measurement, the rechargeable electric energy storage system may be disconnected.
status: draft
summary: Regulation unit `s5-4-3-3` from xml_fmvss-571-305.
title: S5.4.3.3 Electrical isolation of high voltage sources for charging the electric
  energy storage device. For the vehicle c
updated: '2026-04-13'
---

# S5.4.3.3 Electrical isolation of high voltage sources for charging the electric energy storage device. For the vehicle c
