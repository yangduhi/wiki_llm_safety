...
basis: '(h) For any tested door edge that does not contain at least one latch/striker,
  the following set-up procedures are used:'
browse_buckets:
- door_retention
clause_path: h
comparison_key: 06f16f2a819daf16e2b55473f1de8f68d36efecc
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-h
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / h
source_collection: xml_fmvss
source_url: null
statement: '(h) For any tested door edge that does not contain at least one latch/striker,
  the following set-up procedures are used:'
status: draft
subject: null
summary: Regulation unit `h` from xml_fmvss-571-206.
title: '(h) For any tested door edge that does not contain at least one latch/striker,
  the following set-up procedures are used:'
updated: '2026-04-13'
---
