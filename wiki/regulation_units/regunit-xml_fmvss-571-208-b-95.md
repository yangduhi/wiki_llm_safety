...
basis: (b) If the child restraint is certified to S5.9 of § 571.213, and the vehicle
  ...
  provided by the child restraint manufacturer for attachment to the lower anchorages
  as specified in S20.2.1.6.
browse_buckets:
- occupant_restraints
- child_restraints
- seat_systems
clause_path: b-95
comparison_key: b303d76557ac7bfde461550aa0a72483fb25f926
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-b-95
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / b-95
...
status: draft
subject: null
summary: Regulation unit `b-95` from xml_fmvss-571-208.
