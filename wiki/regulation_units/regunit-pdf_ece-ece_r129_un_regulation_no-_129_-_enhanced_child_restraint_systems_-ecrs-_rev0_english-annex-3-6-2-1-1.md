...
basis: '6.2.1.1.
  ...
  The restraint of the child shall give the required protection in any position

  specified for the Child Restraint System;

  For "Special Needs Restraints" the primary means of restraint shall give the

  required protection in any intended position of the Child Restraint System

  without the use of the additional restraining devices which may be present;'
browse_buckets:
- child_restraints
clause_path: annex-3-6-2-1-1
comparison_key: 45c4746e2ca5c07e84c8beea34c5467ecebef618
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-3-6-2-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-3-6-2-1-1` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 6.2.1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-3-6-2-1-1
- source_url: n/a
- confidence: medium
