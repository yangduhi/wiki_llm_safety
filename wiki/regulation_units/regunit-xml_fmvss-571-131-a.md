...
basis: (a) The stop signal arm is perpendicular to the side of the bus, plus or minus
  five degrees;
browse_buckets:
- side_impact
- pedestrian_protection
clause_path: a
comparison_key: 30ea63e28f5acf20adc604323a4576d7e068183e
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-131-a
...
- pedestrian
sectno: null
source_citation: xml_fmvss-571-131 / a
source_collection: xml_fmvss
source_url: null
statement: (a) The stop signal arm is perpendicular to the side of the bus, plus or
  minus five degrees;
status: draft
subject: null
summary: Regulation unit `a` from xml_fmvss-571-131.
title: (a) The stop signal arm is perpendicular to the side of the bus, plus or minus
  five degrees;
updated: '2026-04-13'
---
