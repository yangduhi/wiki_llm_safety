...
basis: '6.2.2.
  ...
  In the case when an overload protector is fitted or intended to be fitted within
  the

  inertia (overrun) braking system, the wheel brake shall be tested with the following

  test forces or pressures:'
browse_buckets: []
clause_path: annex-12-6-2-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-12-6-2-2
...
status: draft
subject: null
summary: Regulation unit `annex-12-6-2-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 6.2.2.
updated: '2026-04-13'
---
...
## Basis
6.2.2.
In the case when an overload protector is fitted or intended to be fitted within the
inertia (overrun) braking system, the wheel brake shall be tested with the following
test forces or pressures:
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-12-6-2-2
- source_url: n/a
- confidence: medium
