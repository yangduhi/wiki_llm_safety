...
basis: (A) an unoccupied seat if the system is able to determine whether or not a
  seat is occupied;
browse_buckets:
- occupant_restraints
- seat_systems
clause_path: a-44
comparison_key: 207a948ac1a5f12fb735bbfd3bb8ad37ee4892db
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-a-44
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / a-44
source_collection: xml_fmvss
source_url: null
statement: (A) an unoccupied seat if the system is able to determine whether or not
  a seat is occupied;
status: draft
subject: null
summary: Regulation unit `a-44` from xml_fmvss-571-208.
title: (A) an unoccupied seat if the system is able to determine whether or not a
  seat is occupied;
updated: '2026-04-13'
---
