...
basis: (d) The windshield wipers may be used during the test if they are operated
  without manual assist;
browse_buckets: []
clause_path: d
comparison_key: 78677813a3e3db366c7f9f0acf3046892a2956a7
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-103-d
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-103 / d
source_collection: xml_fmvss
source_url: null
statement: (d) The windshield wipers may be used during the test if they are operated
  without manual assist;
status: draft
subject: null
summary: Regulation unit `d` from xml_fmvss-571-103.
title: (d) The windshield wipers may be used during the test if they are operated
  without manual assist;
updated: '2026-04-13'
---
