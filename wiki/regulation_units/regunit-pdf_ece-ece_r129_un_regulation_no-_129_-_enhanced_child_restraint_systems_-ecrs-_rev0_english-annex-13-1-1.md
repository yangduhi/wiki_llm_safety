...
basis: '1.1.
  ...
  The headform shall consist of a solid wooden hemisphere with an added

  smaller spherical segment as shown in Figure A below. It shall be

  constructed so that it can be dropped freely along the axis marked and it shall

  have provision for mounting an accelerometer in order to measure the

  acceleration along the direction of fall.'
browse_buckets:
- head_impact
- child_restraints
clause_path: annex-13-1-1
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-13-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-13-1-1` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-13-1-1
- source_url: n/a
- confidence: medium
