...
basis: S4.2.7.5 Any rear designated seating position adjacent to a walkway located
  ...
  S4.2.7.1 by use of a belt incorporating a release mechanism that detaches both the
...
# S4.2.7.5 Any rear designated seating position adjacent to a walkway located between the seat and the side of the vehicle
