...
basis: '4.5.3.3.
  ...
  The test machine shall be calibrated for speed and brake torque within an

  accuracy of 2 per cent taking into account the internal friction characteristics.

  The dynamic rolling radius of the tyre (R) shall be determined by measuring the

  rotational speed of the rolling road and the unbraked wheels of the axle under test

  at a speed equivalent to 60 km/h, and calculated by the formula
  ...
  = rotational speed of rolling road

  nw = rotational speed of the unbraked wheels of the axle'
browse_buckets: []
clause_path: annex-19-4-5-3-3
comparison_key: 929fef0acf8759c592f2fa43cb762cd4d34e10d9
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-19-4-5-3-3
...
status: draft
subject: null
summary: Regulation unit `annex-19-4-5-3-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 4.5.3.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-19-4-5-3-3
- source_url: n/a
- confidence: medium
