...
basis: 가) 위 2) 또는 6)에 따라 자동차로유지기능이 해제되는 경우
browse_buckets: []
clause_path: 2-6-183
comparison_key: 7c3d43dfaae414239b03d138e61d50d5052369d8
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-2-6-183
...
parent_title: 가) 위 2) 또는 6)에 따라 자동차로유지기능이 해제되는 경우
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 2-6-183
source_collection: xml_kmvss
source_url: null
statement: 가) 위 2) 또는 6)에 따라 자동차로유지기능이 해제되는 경우
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `2-6-183` from xml_kmvss-kmvss_att_0027_128.
title: 가) 위 2) 또는 6)에 따라 자동차로유지기능이 해제되는 경우
updated: '2026-04-13'
---

# 가) 위 2) 또는 6)에 따라 자동차로유지기능이 해제되는 경우
