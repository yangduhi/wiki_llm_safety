...
basis: (b) 100 ohms/volt for an AC high voltage source if it is conductively connected
  to a DC high voltage source, but only if the AC high voltage source meets the requirements
  for protection against direct contact in S5.4.1.4 and the protection from indirect
  contact in S5.4.2; or
browse_buckets: []
clause_path: b-6
comparison_key: db894d9b940a69c5c234fa8be413c47ec71f6b8f
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305-b-6
...
sectno: null
source_citation: xml_fmvss-571-305 / b-6
source_collection: xml_fmvss
source_url: null
statement: (b) 100 ohms/volt for an AC high voltage source if it is conductively connected
  to a DC high voltage source, but only if the AC high voltage source meets the requirements
  for protection against direct contact in S5.4.1.4 and the protection from indirect
  contact in S5.4.2; or
status: draft
subject: null
summary: Regulation unit `b-6` from xml_fmvss-571-305.
title: (b) 100 ohms/volt for an AC high voltage source if it is conductively connected
  to a DC high voltage source, but only if
updated: '2026-04-13'
---

# (b) 100 ohms/volt for an AC high voltage source if it is conductively connected to a DC high voltage source, but only if
