...
basis: '1.1.
  ...
  For tests on child restraints, the trolley, carrying the seat only, shall have a

  mass greater than 380 kg. For tests on Child Restraint Systems in the

  "Specific vehicle’ ISOFIX" category, the trolley with the attached vehicle

  structure shall have a mass greater than 800 kg.'
browse_buckets:
- child_restraints
- seat_systems
...
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-6-1-1
...
status: draft
subject: null
summary: Regulation unit `annex-6-1-1` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 1.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-6-1-1
- source_url: n/a
- confidence: medium
