...
basis: (c) Shall not be combined with the readiness indicator required by S4.5.2 of
  this standard.
browse_buckets:
- occupant_restraints
clause_path: c-47
comparison_key: 8e729e738962aa3a63eae6913bfeb9d7ff86bab1
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-c-47
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / c-47
source_collection: xml_fmvss
source_url: null
statement: (c) Shall not be combined with the readiness indicator required by S4.5.2
  of this standard.
status: draft
subject: null
summary: Regulation unit `c-47` from xml_fmvss-571-208.
title: (c) Shall not be combined with the readiness indicator required by S4.5.2 of
  this standard.
updated: '2026-04-13'
---
