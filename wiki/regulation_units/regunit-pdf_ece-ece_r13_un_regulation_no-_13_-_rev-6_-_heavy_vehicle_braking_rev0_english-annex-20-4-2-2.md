...
basis: '4.2.2.
  ...
  The brake factor is the resultant amplification factor achieved through the friction

  forces generated by the individual components comprising the brake assembly,

  and is expressed as a ratio between the output torque and the input torque. This

  brake factor is denoted by the symbol BF and shall be verified for each of the

  lining or pad materials specified in paragraph 4.3.1.3.'
browse_buckets: []
clause_path: annex-20-4-2-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-20-4-2-2
...
status: draft
subject: null
summary: Regulation unit `annex-20-4-2-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 4.2.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-20-4-2-2
- source_url: n/a
- confidence: medium
