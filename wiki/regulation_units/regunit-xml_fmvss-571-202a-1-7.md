...
basis: '(1) Adjust the head restraint so that its top is at a height closest to and
  not less than:'
browse_buckets:
- head_impact
clause_path: 1-7
comparison_key: 421932ae0caae9d5f4d7f002d6ee7ffaf7e44686
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-202a-1-7
...
phase: cross_phase
primary_topic: 1-adjust-the-head-restraint-so-that-its-top-is-at-a-height-closest-to-and-not-le
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-202a / 1-7
source_collection: xml_fmvss
source_url: null
statement: '(1) Adjust the head restraint so that its top is at a height closest to
  and not less than:'
status: draft
subject: null
summary: Regulation unit `1-7` from xml_fmvss-571-202a.
title: '(1) Adjust the head restraint so that its top is at a height closest to and
  not less than:'
updated: '2026-04-13'
---
