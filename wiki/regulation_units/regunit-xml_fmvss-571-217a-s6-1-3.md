...
basis: 'S6.1.3 Center impact to pre-broken glazing.

  Position the center of the impactor face, with the long axis of the impactor face
  plate either vertical or horizontal, at the center of the daylight opening area
  of the window with the glazing pre-broken following the procedure in paragraphs
  S6.2.1 and S6.2.2 of this section.'
browse_buckets:
- anti_ejection
- glazing_retention
clause_path: s6-1-3
comparison_key: 1c7511138dd4e51b1f979ef1ea3156f05ca1e53c
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-217a-s6-1-3
...
phase: cross_phase
primary_topic: s6-1-3-center-impact-to-pre-broken-glazing
provenance:
...
- glazing
sectno: null
source_citation: xml_fmvss-571-217a / s6-1-3
source_collection: xml_fmvss
source_url: null
statement: S6.1.3 Center impact to pre-broken glazing.
status: draft
subject: null
summary: Regulation unit `s6-1-3` from xml_fmvss-571-217a.
title: S6.1.3 Center impact to pre-broken glazing.
updated: '2026-04-13'
---
