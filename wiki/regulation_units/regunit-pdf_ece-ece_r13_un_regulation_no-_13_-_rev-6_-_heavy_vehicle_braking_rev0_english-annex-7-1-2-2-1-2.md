...
basis: '1.2.2.1.
  ...
  the initial energy level in the energy storage device(s) shall be that specified
  by the

  manufacturer 1/. It shall be such as to enable the prescribed performance of the

  service braking system to be achieved and shall correspond to a vacuum not

  exceeding 90 per cent of the maximum vacuum furnished by the energy source;'
browse_buckets: []
clause_path: annex-7-1-2-2-1-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-1-2-2-1-2
...
status: draft
subject: null
summary: Regulation unit `annex-7-1-2-2-1-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.2.2.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-1-2-2-1-2
- source_url: n/a
- confidence: medium
