...
basis: (2) Apply the test load at a rate not to exceed 5 mm/min until the required
  load has been achieved. Failure consists of a separation of either hinge. Record
  the maximum load achieved.
browse_buckets:
- door_retention
clause_path: 2-8
comparison_key: 17f746ccc14b3190aaec3d2c4889be57a87c8e3f
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-2-8
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / 2-8
source_collection: xml_fmvss
source_url: null
statement: (2) Apply the test load at a rate not to exceed 5 mm/min until the required
  load has been achieved. Failure consists of a separation of either hinge. Record
  the maximum load achieved.
status: draft
subject: null
summary: Regulation unit `2-8` from xml_fmvss-571-206.
title: '(2) Apply the test load at a rate not to exceed 5 mm/min until the required
  load has been achieved. Failure consists of '
updated: '2026-04-13'
---

# (2) Apply the test load at a rate not to exceed 5 mm/min until the required load has been achieved. Failure consists of 
