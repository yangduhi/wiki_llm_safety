...
basis: '1.
  ...
  verification with respect to the safety aspects of complex electronic vehicle

  control systems (paragraph 2.3. below) as far as this Regulation is concerned.
  ...
  This annex does not specify the performance criteria for "the system" but covers
  the

  methodology applied to the design process and the information which shall be
  ...
  conditions, all the appropriate performance requirements specified elsewhere in
  this

  Regulation.'
browse_buckets: []
clause_path: annex-18-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-18-1
...
status: draft
subject: null
summary: Regulation unit `annex-18-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: '1.'
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-18-1
- source_url: n/a
- confidence: medium
