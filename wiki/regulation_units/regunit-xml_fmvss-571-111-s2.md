...
basis: S2. Purpose. The purpose of this standard is to reduce the number of deaths
  and injuries that occur when the driver of a motor vehicle does not have a clear
  and reasonably unobstructed view to the rear.
browse_buckets: []
clause_path: s2
comparison_key: 8f20e3459f78ddb7433d9e08707dd0792a461a60
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-111-s2
...
- visibility
sectno: null
source_citation: xml_fmvss-571-111 / s2
...
status: draft
subject: null
summary: Regulation unit `s2` from xml_fmvss-571-111.
title: S2. Purpose. The purpose of this standard is to reduce the number of deaths
  and injuries that occur when the driver of a
updated: '2026-04-13'
---

# S2. Purpose. The purpose of this standard is to reduce the number of deaths and injuries that occur when the driver of a
