...
basis: S9.1 Test method to evaluate protection from direct contact with high voltage
  sources.
browse_buckets: []
clause_path: s9-1
comparison_key: eb626ba8cb2372bd577a2be24e8b09752523857c
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305-s9-1
...
sectno: null
source_citation: xml_fmvss-571-305 / s9-1
source_collection: xml_fmvss
source_url: null
statement: S9.1 Test method to evaluate protection from direct contact with high voltage
  sources.
status: draft
subject: null
summary: Regulation unit `s9-1` from xml_fmvss-571-305.
title: S9.1 Test method to evaluate protection from direct contact with high voltage
  sources.
updated: '2026-04-13'
---
