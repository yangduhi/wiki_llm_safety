...
basis: (b) Has a tether strap routing device that is—
browse_buckets:
- child_restraints
clause_path: b-8
comparison_key: fab349b9fabcb803b479b37b3abd09c135e4b62c
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-225-b-8
...
phase: cross_phase
primary_topic: b-has-a-tether-strap-routing-device-that-is
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-225 / b-8
source_collection: xml_fmvss
source_url: null
statement: (b) Has a tether strap routing device that is—
status: draft
subject: null
summary: Regulation unit `b-8` from xml_fmvss-571-225.
title: (b) Has a tether strap routing device that is—
updated: '2026-04-13'
---
