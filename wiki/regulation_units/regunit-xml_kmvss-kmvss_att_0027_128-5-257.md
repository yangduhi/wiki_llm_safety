...
basis: '5) 작동상태에 있는 자동차로유지기능은 주행 중인 차로 전방의 자동차와의 거

  리를 다음과 같이 조절할 수 있을 것'
browse_buckets: []
clause_path: 5-257
comparison_key: 013e524dab0fbde0957b9d21642f0e5db6b52fef
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-5-257
...
parent_title: 5) 작동상태에 있는 자동차로유지기능은 주행 중인 차로 전방의 자동차와의 거
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 5-257
source_collection: xml_kmvss
source_url: null
statement: 5) 작동상태에 있는 자동차로유지기능은 주행 중인 차로 전방의 자동차와의 거
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `5-257` from xml_kmvss-kmvss_att_0027_128.
title: 5) 작동상태에 있는 자동차로유지기능은 주행 중인 차로 전방의 자동차와의 거
updated: '2026-04-13'
---

# 5) 작동상태에 있는 자동차로유지기능은 주행 중인 차로 전방의 자동차와의 거
