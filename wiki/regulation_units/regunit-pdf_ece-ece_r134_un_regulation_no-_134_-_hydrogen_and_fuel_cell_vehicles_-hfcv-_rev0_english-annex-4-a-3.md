...
basis: '(a)
  ...
  Six TPRD units are dropped from a height of 2 m at ambient

  temperature (20 ± 5 °C ) onto a smooth concrete surface. Each sample

  is allowed to bounce on the concrete surface after the initial impact.

  One unit is dropped in six orientations (opposing directions of 3

  orthogonal axes: vertical, lateral and longitudinal). If each of the six

  dropped samples does not show visible exterior damage that indicates

  that the part is unsuitable for use, it shall proceed to step (b) ;'
browse_buckets:
- fuel_system_integrity
clause_path: annex-4-a-3
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-4-a-3
...
status: draft
subject: null
summary: Regulation unit `annex-4-a-3` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: (a)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-4-a-3
- source_url: n/a
- confidence: medium
