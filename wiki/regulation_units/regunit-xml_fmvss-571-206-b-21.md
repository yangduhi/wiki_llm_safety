...
basis: (b) Apply the test load at a rate not to exceed 5 mm/min until the required
  load has been achieved. Record maximum load achieved.
browse_buckets:
- door_retention
clause_path: b-21
comparison_key: 452c4c9d99ca2ba35ed968a2928e489dfa0c5b98
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-b-21
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / b-21
source_collection: xml_fmvss
source_url: null
statement: (b) Apply the test load at a rate not to exceed 5 mm/min until the required
  load has been achieved. Record maximum load achieved.
status: draft
subject: null
summary: Regulation unit `b-21` from xml_fmvss-571-206.
title: '(b) Apply the test load at a rate not to exceed 5 mm/min until the required
  load has been achieved. Record maximum load '
updated: '2026-04-13'
---

# (b) Apply the test load at a rate not to exceed 5 mm/min until the required load has been achieved. Record maximum load 
