...
basis: '2.2.2.
  ...
  Where it is intended to couple to the power-driven vehicle, a trailer whose service

  braking system is vacuum-operated, the trailer shall be represented by an energy

  storage device having a capacity V in litres determined by the formula V = 15 R,

  where R is the maximum permissible mass, in tonnes, on the axles of the trailer.
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-7-2-2-2-2
...
status: draft
subject: null
summary: Regulation unit `annex-7-2-2-2-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.2.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-7-2-2-2-2
- source_url: n/a
- confidence: medium
