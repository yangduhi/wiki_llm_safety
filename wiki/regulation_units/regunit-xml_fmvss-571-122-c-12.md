...
basis: (c) Brake application. Simultaneous actuation of both service brake system
...
browse_buckets: []
clause_path: c-12
comparison_key: 065946929f193ada11dea534602fb969bccac39e
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-122-c-12
...
phase: cross_phase
primary_topic: c-brake-application-simultaneous-actuation-of-both-service-brake-system-controls
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-122 / c-12
source_collection: xml_fmvss
source_url: null
statement: (c) Brake application. Simultaneous actuation of both service brake system
  controls, if so equipped, or of the single service brake system control in the case
  of a service brake system that operates on all wheels.
status: draft
subject: null
summary: Regulation unit `c-12` from xml_fmvss-571-122.
title: (c) Brake application. Simultaneous actuation of both service brake system
  controls, if so equipped, or of the single se
updated: '2026-04-13'
---

# (c) Brake application. Simultaneous actuation of both service brake system controls, if so equipped, or of the single se
