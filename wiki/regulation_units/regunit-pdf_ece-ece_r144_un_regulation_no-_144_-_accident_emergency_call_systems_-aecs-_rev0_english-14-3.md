...
basis: '14.3.
  ...
  For each type of AECD, the application shall be accompanied by samples of

  complete sets of AECDs representative of the type to be approved, in

  sufficient quantities for the tests prescribed by this Regulation. Additional

  specimens may be called for at the request of the Technical Service

  responsible for conducting the test.'
browse_buckets: []
clause_path: 14-3
comparison_key: 7d0833016591ea8e1426aaa385ba995857c1d899
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-14-3
...
status: draft
subject: null
summary: Regulation unit `14-3` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: 14.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / 14-3
- source_url: n/a
- confidence: medium
