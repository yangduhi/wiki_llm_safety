...
basis: '5.2.5.
  ...
  The laden test on the high adhesion surface may be omitted if the prescribed force
  on

  the control device does not achieve full cycling of the anti-lock system.

  For the unladen test, the control force may be increased up to 100 daN if no cycling
  is

  achieved with its full force value 8/. If 100 daN is insufficient to make the system

  cycle, then this test may be omitted. For air braking systems the air pressure may
  not

  be increased above the cut-out pressure for the purpose of this test.'
browse_buckets: []
clause_path: annex-13-5-2-5
comparison_key: 2a686b6656bdf2ab16995f035cea56e17b0c922a
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-13-5-2-5
...
status: draft
subject: null
summary: Regulation unit `annex-13-5-2-5` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.2.5.
updated: '2026-04-13'
---
...
achieved with its full force value 8/. If 100 daN is insufficient to make the system
cycle, then this test may be omitted. For air braking systems the air pressure may not
be increased above the cut-out pressure for the purpose of this test.

## Authority
- clause_path: annex-13-5-2-5
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-13-5-2-5
- source_url: n/a
- confidence: medium
