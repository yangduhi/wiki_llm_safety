...
basis: '3.1.3.4.
  ...
  In the Type-III test of a semi-trailer, the mass braked by the latter''s axle(s)
  shall

  correspond to the maximum axle load(s).
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-3-1-3-4
...
status: draft
subject: null
summary: Regulation unit `annex-4-3-1-3-4` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.1.3.4.
updated: '2026-04-13'
---
...
## Basis
3.1.3.4.
In the Type-III test of a semi-trailer, the mass braked by the latter's axle(s) shall
correspond to the maximum axle load(s).
E/ECE/324
E/ECE/TRANS/505
} Rev.1/Add.12/Rev.6
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-3-1-3-4
- source_url: n/a
- confidence: medium
