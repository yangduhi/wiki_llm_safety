...
basis: '33.3.
  ...
  For each vehicle type equipped with an AECS, the application shall be

  accompanied by samples of vehicles representative of the type to be

  approved and where appropriate, samples of components, in sufficient

  quantities for the tests prescribed by this Regulation. Additional specimens

  may be called for at the request of the Technical Service responsible for

  conducting the test.'
browse_buckets: []
clause_path: appendix-of-33-3
comparison_key: 9d0837eba7aedbd24a06bc453d322fa70008a980
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-appendix-of-33-3
...
status: draft
subject: null
summary: Regulation unit `appendix-of-33-3` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: 33.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / appendix-of-33-3
- source_url: n/a
- confidence: medium
