...
basis: '3.1.2.2.
  ...
  supply line shall not exceed 700 kPa during the brake test and the signal value
  in

  the control line shall not exceed the following values, depending on the

  installation:'
browse_buckets: []
clause_path: annex-4-3-1-2-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-3-1-2-2
...
status: draft
subject: null
summary: Regulation unit `annex-4-3-1-2-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.1.2.2.
updated: '2026-04-13'
---
...
3.1.2.2.
If the trailer is fitted with a compressed-air braking system, the pressure in the
supply line shall not exceed 700 kPa during the brake test and the signal value in
the control line shall not exceed the following values, depending on the
installation:
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-3-1-2-2
- source_url: n/a
- confidence: medium
