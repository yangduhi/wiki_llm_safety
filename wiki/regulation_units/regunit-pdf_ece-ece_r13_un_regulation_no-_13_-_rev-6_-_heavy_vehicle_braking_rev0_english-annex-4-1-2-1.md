...
basis: '1.2.1.
  ...
  the vehicle''s condition as regards mass shall be as prescribed for each type of
  test

  and be specified in the test report;'
browse_buckets: []
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-1-2-1
...
status: draft
subject: null
summary: Regulation unit `annex-4-1-2-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.2.1.
updated: '2026-04-13'
---
...
## Basis
1.2.1.
the vehicle's condition as regards mass shall be as prescribed for each type of test
and be specified in the test report;

## Authority
- clause_path: annex-4-1-2-1
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-1-2-1
- source_url: n/a
- confidence: medium
