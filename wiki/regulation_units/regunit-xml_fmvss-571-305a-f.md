...
basis: '(f) Charging is continued until one of the following occurs:'
browse_buckets: []
clause_path: f
comparison_key: ece83a79da1e0f6a309c4014a9a6c98aeacbef69
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-305a-f
...
phase: post_crash
primary_topic: f-charging-is-continued-until-one-of-the-following-occurs
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-305a / f
source_collection: xml_fmvss
source_url: null
statement: '(f) Charging is continued until one of the following occurs:'
status: draft
subject: null
summary: Regulation unit `f` from xml_fmvss-571-305a.
title: '(f) Charging is continued until one of the following occurs:'
updated: '2026-04-13'
---
