...
attachment_section: 'Annex 11, Appendix 2, para.:'
basis: '2.3.

  This item is to be completed only when the brake has been subject to the test

  procedure defined in paragraph 4. of Annex 19 to this Regulation to verify the cold

  performance characteristics of the brake by means of the brake factor (BF), where

  this brake factor is defined as: input to output amplification ratio of the brake.'
browse_buckets: []
clause_path: annex-11-2-3
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-11-2-3
...
status: draft
subject: null
summary: Regulation unit `annex-11-2-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-11-2-3
- source_url: n/a
- confidence: medium
