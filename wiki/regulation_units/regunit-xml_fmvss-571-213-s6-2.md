...
basis: 'S6.2 Buckle release test procedure.

  The belt assembly buckles used in any child restraint system shall be tested in
  accordance with S6.2.1 through S6.2.4 inclusive.'
browse_buckets:
- child_restraints
clause_path: s6-2
comparison_key: 7e57dd2cbb90b3bba231a3d9f4e9b9fb1764fbd8
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-s6-2
...
phase: cross_phase
primary_topic: s6-2-buckle-release-test-procedure
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / s6-2
source_collection: xml_fmvss
source_url: null
statement: S6.2 Buckle release test procedure.
status: draft
subject: null
summary: Regulation unit `s6-2` from xml_fmvss-571-213.
title: S6.2 Buckle release test procedure.
updated: '2026-04-13'
---
