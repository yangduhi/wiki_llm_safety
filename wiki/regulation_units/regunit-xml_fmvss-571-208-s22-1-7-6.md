...
basis: S22.1.7.6 If adjustable, set the head restraint at the full down and full forward
  position.
browse_buckets:
- occupant_restraints
- head_impact
clause_path: s22-1-7-6
comparison_key: 98da2f912a1cbd9db41e4afef35502f844ffa040
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-s22-1-7-6
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / s22-1-7-6
source_collection: xml_fmvss
source_url: null
statement: S22.1.7.6 If adjustable, set the head restraint at the full down and full
  forward position.
status: draft
subject: null
summary: Regulation unit `s22-1-7-6` from xml_fmvss-571-208.
title: S22.1.7.6 If adjustable, set the head restraint at the full down and full forward
  position.
updated: '2026-04-13'
---
