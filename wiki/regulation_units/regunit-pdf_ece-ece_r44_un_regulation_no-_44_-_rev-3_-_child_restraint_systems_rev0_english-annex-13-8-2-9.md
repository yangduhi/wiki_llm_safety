...
basis: '8.2.9.
  ...
  The complete seat, or the component fitted with ISOFIX attachments (e.g.

  ISOFIX base) if it has a release button, is attached rigidly to a test rig in such

  a way that ISOFIX connectors are vertically aligned as shown in Figure 7. A

  6 mm diameter bar, 350 mm long, shall be attached to the ISOFIX

  connectors. A mass of 5 kg shall be attached to the extremities of the bar.'
browse_buckets:
- child_restraints
- seat_systems
clause_path: annex-13-8-2-9
comparison_key: 586ed770a3a4f6bf9589ec53b63964223611bb85
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english-annex-13-8-2-9
...
status: draft
subject: null
summary: Regulation unit `annex-13-8-2-9` from pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english.
title: 8.2.9.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english / annex-13-8-2-9
- source_url: n/a
- confidence: medium
