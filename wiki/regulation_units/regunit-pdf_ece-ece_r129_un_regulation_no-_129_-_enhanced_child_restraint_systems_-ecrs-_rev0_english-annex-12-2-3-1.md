...
basis: '2.3.1.
  ...
  For "Specific vehicle ISOFIX" devices, the following test frequencies shall

  apply once every eight weeks:

  At each test all requirements according to paragraphs 6.6.4. and 6.7.1.7.1. of

  this Regulation shall be fulfilled. If all tests during one year show satisfactory

  results, the manufacturer may, after agreement with the Type Approval

  Authority, reduce the frequencies as follows: once every 16 weeks.
...
browse_buckets: []
clause_path: annex-12-2-3-1
comparison_key: caf2ce7f94cf6dae621be94c57503bfd7c1a0b25
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english-annex-12-2-3-1
...
status: draft
subject: null
summary: Regulation unit `annex-12-2-3-1` from pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english.
title: 2.3.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r129_un_regulation_no-_129_-_enhanced_child_restraint_systems_-ecrs-_rev0_english / annex-12-2-3-1
- source_url: n/a
- confidence: medium
