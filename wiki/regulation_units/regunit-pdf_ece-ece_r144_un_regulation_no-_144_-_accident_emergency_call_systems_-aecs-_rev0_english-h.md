...
basis: '(h)
  ...
  Warning signal device;2

  2 The length of the harness, and when applicable its fixation, can be decided by
  the applicant, in

  agreement with the Technical Service, so that it represents the different installation
  configurations of
...
browse_buckets: []
clause_path: h
comparison_key: a3b56b8b197b5ca89b9ac5c3e13e4639f70ea593
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-h
...
status: draft
subject: null
summary: Regulation unit `h` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: (h)
updated: '2026-04-13'
---
...
(h)
Warning signal device;2
2 The length of the harness, and when applicable its fixation, can be decided by the applicant, in
agreement with the Technical Service, so that it represents the different installation configurations of
the AECC.
E/ECE/TRANS/505/Rev.3/Add.143
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / h
- source_url: n/a
- confidence: medium
