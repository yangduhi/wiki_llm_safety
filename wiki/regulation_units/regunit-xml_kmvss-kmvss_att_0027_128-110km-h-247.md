...
basis: 가) 최대작동속도는 110km/h를 초과하지 않을 것
browse_buckets: []
clause_path: 110km-h-247
comparison_key: c98d672d80e7e9eac95b7f47546871a9b138a99c
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-110km-h-247
...
parent_title: 가) 최대작동속도는 110km/h를 초과하지 않을 것
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / 110km-h-247
source_collection: xml_kmvss
source_url: null
statement: 가) 최대작동속도는 110km/h를 초과하지 않을 것
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `110km-h-247` from xml_kmvss-kmvss_att_0027_128.
title: 가) 최대작동속도는 110km/h를 초과하지 않을 것
updated: '2026-04-13'
---

# 가) 최대작동속도는 110km/h를 초과하지 않을 것
