...
basis: '7.2.4.
  ...
  The axle load(s) designated by the manufacturer to enable the setting of the device

  to be checked in service if this is (these are) different from the loads specified
  in

  paragraphs 7.2.1. to 7.2.3. of this annex.'
browse_buckets: []
clause_path: annex-10-7-2-4
comparison_key: 2a96cf6eb72832f102543ad624fad1762ea50558
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-10-7-2-4
...
status: draft
subject: null
summary: Regulation unit `annex-10-7-2-4` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 7.2.4.
updated: '2026-04-13'
---
...
7.2.4.
The axle load(s) designated by the manufacturer to enable the setting of the device
to be checked in service if this is (these are) different from the loads specified in
paragraphs 7.2.1. to 7.2.3. of this annex.

## Authority
- clause_path: annex-10-7-2-4
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-10-7-2-4
- source_url: n/a
- confidence: medium
