...
basis: 'Annex 4
  ...
  load for each axle. In the case of tractors for semi- trailers, the load may be
  re-

  positioned approximately half-way between the kingpin position resulting from

  the above loading conditions and the centreline of the rear axle(s);'
browse_buckets:
- rear_impact
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-14
...
status: draft
subject: null
summary: Regulation unit `annex-4-14` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: Annex 4
updated: '2026-04-13'
---
...
## Basis
Annex 4
load for each axle. In the case of tractors for semi- trailers, the load may be re-
positioned approximately half-way between the kingpin position resulting from
the above loading conditions and the centreline of the rear axle(s);
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-14
- source_url: n/a
- confidence: medium
