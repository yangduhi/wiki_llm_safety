...
basis: '7.4.3.
  ...
  Torque M* as a function of the pressure p* applied to the brake cylinder in hydraulic

  transmission systems.

  The rotational speed of the braking surfaces shall correspond to an initial vehicle

  speed of 60 km/h when the trailer moves forward and 6 km/h when the trailer moves

  rearward. The following shall be derived from the curve obtained from these

  measurements (see Figure 7 of Appendix 1 to this annex):'
browse_buckets:
- rear_impact
clause_path: annex-12-7-4-3
comparison_key: 4c8b4a889e6d4371bd924e9ba0463be8d7474459
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-12-7-4-3
...
status: draft
subject: null
summary: Regulation unit `annex-12-7-4-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 7.4.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-12-7-4-3
- source_url: n/a
- confidence: medium
