...
basis: '(b)
  ...
  When V1, V2 (see Figure 1) are measured at a point in time between

  5 seconds and 60 seconds after the impact and the capacitances of the

  Y-capacitors (Cy1, Cy2) are specified by the manufacturer, total energy

  (TEy1, TEy2) shall be calculated according to the following formulas:'
browse_buckets: []
clause_path: annex-9-b
comparison_key: ae55c2e6147263d08f4878eb2dc584f7ca282e62
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english-annex-9-b
...
status: draft
subject: null
summary: Regulation unit `annex-9-b` from pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r95_un_regulation_no-_95_-_rev-2_-_lateral_collision_protection_rev0_english / annex-9-b
- source_url: n/a
- confidence: medium
