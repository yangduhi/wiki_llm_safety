...
basis: '2.3.1.
  ...
  Power-driven vehicles having a maximum mass exceeding 16 tonnes, or authorized to

  tow a trailer of category O4 shall be fitted with an endurance braking system

  according to paragraph 2.15. of this Regulation which complies with the following

  requirements:'
browse_buckets: []
clause_path: annex-5-2-3-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-5-2-3-1
...
status: draft
subject: null
summary: Regulation unit `annex-5-2-3-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 2.3.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-5-2-3-1
- source_url: n/a
- confidence: medium
