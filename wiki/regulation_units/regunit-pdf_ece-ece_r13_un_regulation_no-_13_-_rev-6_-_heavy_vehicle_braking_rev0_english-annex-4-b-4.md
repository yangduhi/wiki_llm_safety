...
basis: '(b)
  ...
  a digital demand value corresponding to 650 kPa (as defined in

  ISO 11992:2003 in the electric control line.

  The test speed is 60 km/h. A supplementary test at 40 km/h shall be carried out

  with the laden trailer for comparison with the Type-I test result.'
browse_buckets: []
clause_path: annex-4-b-4
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-b-4
...
status: draft
subject: null
summary: Regulation unit `annex-4-b-4` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-b-4
- source_url: n/a
- confidence: medium
