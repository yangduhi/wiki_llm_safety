...
basis: '(f) For any tested door edge that contains one latch/striker, the following
  set-up procedures are used:'
browse_buckets:
- door_retention
clause_path: f-2
comparison_key: 8a10ae665948f487773983558edcdda7e6bb7210
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-f-2
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / f-2
source_collection: xml_fmvss
source_url: null
statement: '(f) For any tested door edge that contains one latch/striker, the following
  set-up procedures are used:'
status: draft
subject: null
summary: Regulation unit `f-2` from xml_fmvss-571-206.
title: '(f) For any tested door edge that contains one latch/striker, the following
  set-up procedures are used:'
updated: '2026-04-13'
---
