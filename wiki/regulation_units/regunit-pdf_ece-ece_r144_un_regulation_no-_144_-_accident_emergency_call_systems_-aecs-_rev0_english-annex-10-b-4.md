...
basis: '(b)
  ...
  Linear errors for every measurement as defined by formula (7)

  obtained with all AECD/AECS samples do not exceed 15 m under

  open sky conditions for all simulation scripts for at least 95 per cent of

  all measurements.'
browse_buckets: []
clause_path: annex-10-b-4
...
id: regunit-pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english-annex-10-b-4
...
status: draft
subject: null
summary: Regulation unit `annex-10-b-4` from pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r144_un_regulation_no-_144_-_accident_emergency_call_systems_-aecs-_rev0_english / annex-10-b-4
- source_url: n/a
- confidence: medium
