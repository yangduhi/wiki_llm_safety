...
basis: '(b)
  ...
  Yellow in colour if the detection system malfunctions (e.g. circuit

  disconnection, short-circuit, sensor fault). It shall be red in compliance

  with section paragraph 7.1.4.3;'
browse_buckets:
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-3-b-6
...
status: draft
subject: null
summary: Regulation unit `annex-3-b-6` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: (b)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-3-b-6
- source_url: n/a
- confidence: medium
