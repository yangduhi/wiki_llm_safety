...
basis: (3) Apply the test load, in the direction specified in S4.1.1.1 and Figure
  5, at a rate not to exceed 5 mm/min until the required load has been achieved. Record
  maximum load achieved.
browse_buckets:
- door_retention
clause_path: 3-3
comparison_key: 63729333e4af94561fa3e1f391472fc78a134522
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-3-3
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / 3-3
source_collection: xml_fmvss
source_url: null
statement: (3) Apply the test load, in the direction specified in S4.1.1.1 and Figure
  5, at a rate not to exceed 5 mm/min until the required load has been achieved. Record
  maximum load achieved.
status: draft
subject: null
summary: Regulation unit `3-3` from xml_fmvss-571-206.
title: (3) Apply the test load, in the direction specified in S4.1.1.1 and Figure
  5, at a rate not to exceed 5 mm/min until the
updated: '2026-04-13'
---

# (3) Apply the test load, in the direction specified in S4.1.1.1 and Figure 5, at a rate not to exceed 5 mm/min until the
