...
basis: '1.2.
  ...
  with that obtained from the brake linings with which the vehicle was equipped at
  the

  time of approval and conforming to the components identified in the relevant

  information document, a model of which is given in Annex 2 to this Regulation.'
browse_buckets: []
clause_path: annex-15-1-2
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-15-1-2
...
status: draft
subject: null
summary: Regulation unit `annex-15-1-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 1.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-15-1-2
- source_url: n/a
- confidence: medium
