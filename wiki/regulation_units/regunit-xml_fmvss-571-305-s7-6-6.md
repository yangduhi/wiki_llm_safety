...
basis: S7.6.6 If V1 is greater than or equal to V2, insert a known resistance (Ro)
  between the negative side of the high voltage source and the electrical chassis.
  With the Ro installed, measure the voltage (V1′) as shown in Figure 4 between the
  negative side of the high voltage source and the electrical chassis. Calculate the
  electrical isolation resistance (Ri) according to the formula shown. Divide Ri (in
  ohms) by the working voltage of the high voltage source (in volts) to obtain the
  electrical isolation (in ohms/volt).
browse_buckets: []
clause_path: s7-6-6
comparison_key: 1dfc75e212f40e6f48aa6fa4c454675fe8f3e05b
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305-s7-6-6
...
sectno: null
source_citation: xml_fmvss-571-305 / s7-6-6
source_collection: xml_fmvss
source_url: null
statement: S7.6.6 If V1 is greater than or equal to V2, insert a known resistance
  (Ro) between the negative side of the high voltage source and the electrical chassis.
  With the Ro installed, measure the voltage (V1′) as shown in Figure 4 between the
  negative side of the high voltage source and the electrical chassis. Calculate the
  electrical isolation resistance (Ri) according to the formula shown. Divide Ri (in
  ohms) by the working voltage of the high voltage source (in volts) to obtain the
...
status: draft
subject: null
summary: Regulation unit `s7-6-6` from xml_fmvss-571-305.
title: S7.6.6 If V1 is greater than or equal to V2, insert a known resistance (Ro)
  between the negative side of the high voltag
updated: '2026-04-13'
---

# S7.6.6 If V1 is greater than or equal to V2, insert a known resistance (Ro) between the negative side of the high voltag
