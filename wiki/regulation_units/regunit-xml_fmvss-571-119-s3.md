...
basis: 'S3. Application. This standard applies to:'
browse_buckets: []
clause_path: s3
comparison_key: 23666203f8498a41f53fd33d79a529401b08758e
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-119-s3
...
parent_title: § 571.119 Standard No. 119; New pneumatic tires for motor vehicles with
  ...
  for motorcycles.
phase: cross_phase
primary_topic: s3-application-this-standard-applies-to
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-119 / s3
source_collection: xml_fmvss
source_url: null
statement: 'S3. Application. This standard applies to:'
status: draft
subject: null
summary: Regulation unit `s3` from xml_fmvss-571-119.
title: 'S3. Application. This standard applies to:'
updated: '2026-04-13'
---
