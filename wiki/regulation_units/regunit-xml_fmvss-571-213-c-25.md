...
basis: (c) A child restraint that is recommended by its manufacturer in accordance
  with S5.5 for use either by children in a specified mass range that includes any
  children having a mass greater than 10 kg but not greater than 18 kg, or by children
  in a specified height range that includes any children whose height is greater than
  850 mm but not greater than 1100 mm, is tested with a 12-month-old test dummy conforming
  to part 572 subpart R, and a 3-year-old test dummy conforming to part 572 subpart
  P and S7.2, provided, however, that the 12-month-old dummy is not used to test a
  booster seat.
browse_buckets:
- child_restraints
- seat_systems
clause_path: c-25
comparison_key: c7cf7601b00e8cb15e0a9885c479c74dc6ee1d3e
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-c-25
...
phase: cross_phase
primary_topic: c-a-child-restraint-that-is-recommended-by-its-manufacturer-in-accordance-with-s
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / c-25
source_collection: xml_fmvss
source_url: null
statement: (c) A child restraint that is recommended by its manufacturer in accordance
  with S5.5 for use either by children in a specified mass range that includes any
  children having a mass greater than 10 kg but not greater than 18 kg, or by children
  in a specified height range that includes any children whose height is greater than
  850 mm but not greater than 1100 mm, is tested with a 12-month-old test dummy conforming
...
status: draft
subject: null
summary: Regulation unit `c-25` from xml_fmvss-571-213.
title: (c) A child restraint that is recommended by its manufacturer in accordance
  with S5.5 for use either by children in a sp
updated: '2026-04-13'
---

# (c) A child restraint that is recommended by its manufacturer in accordance with S5.5 for use either by children in a sp
