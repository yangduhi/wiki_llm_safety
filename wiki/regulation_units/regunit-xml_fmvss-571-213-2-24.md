...
basis: (2) When using the test dummies specified in 49 CFR part 572, subparts N, P,
  R or T, performance tests under S6.1 are conducted at any ambient temperature from
  20.6 °C to 22.2 °C and at any relative humidity from 10 percent to 70 percent.
browse_buckets:
- child_restraints
clause_path: 2-24
comparison_key: 305cf7b996c832679b3b9535bd98cf557c7649b0
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-213-2-24
...
phase: cross_phase
primary_topic: 2-when-using-the-test-dummies-specified-in-49-cfr-part-572-subparts-n-p-r-or-t-p
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / 2-24
source_collection: xml_fmvss
source_url: null
statement: (2) When using the test dummies specified in 49 CFR part 572, subparts
  N, P, R or T, performance tests under S6.1 are conducted at any ambient temperature
  from 20.6 °C to 22.2 °C and at any relative humidity from 10 percent to 70 percent.
status: draft
subject: null
summary: Regulation unit `2-24` from xml_fmvss-571-213.
title: (2) When using the test dummies specified in 49 CFR part 572, subparts N, P,
  R or T, performance tests under S6.1 are co
updated: '2026-04-13'
---

# (2) When using the test dummies specified in 49 CFR part 572, subparts N, P, R or T, performance tests under S6.1 are co
