...
attachment_section: Appendix 3 as appropriate)
basis: '4.1.5. Tyre rolling radius (R)

  May change subject to the

  requirements of para. 4.3.1.4. of this

  appendix'
browse_buckets: []
clause_path: appendix-3-4-1-5
comparison_key: 570808190a3e991ea25556dcb00d625208af8508
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-appendix-3-4-1-5
...
phase: cross_phase
primary_topic: 4-1-5-tyre-rolling-radius-r
provenance:
...
source_url: null
statement: 4.1.5. Tyre rolling radius (R)
status: draft
subject: null
summary: Regulation unit `appendix-3-4-1-5` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 4.1.5. Tyre rolling radius (R)
updated: '2026-04-13'
---

# 4.1.5. Tyre rolling radius (R)
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / appendix-3-4-1-5
- source_url: n/a
- confidence: medium
