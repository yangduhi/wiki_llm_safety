...
attachment_section: Annex 4 following the Type-I or Type-III test also defined in
  that annex as
basis: '5.2.2.8.2.
  ...
  replacement is necessary or a sensing device per wheel (twin wheels are

  considered as a single wheel), which will warn the driver at his driving position

  when lining replacement is necessary, is acceptable. The yellow warning signal

  specified in paragraph 5.2.1.29.2. above may be used provided that signal

  complies with the requirements of paragraph 5.2.1.29.6. above.

  5.2.2.8.2.2.

  Assessment of the wear condition of the friction surfaces of brake discs or drums
...
browse_buckets: []
clause_path: annex-4-5-2-2-8-2
comparison_key: 3669c955b8ebcc2b36424b8fe878dd9329dca7cc
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-4-5-2-2-8-2
...
status: draft
subject: null
summary: Regulation unit `annex-4-5-2-2-8-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 5.2.2.8.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-4-5-2-2-8-2
- source_url: n/a
- confidence: medium
