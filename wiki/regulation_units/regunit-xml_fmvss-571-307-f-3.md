...
basis: (f) A leak shall be simulated using the remote controllable function.
browse_buckets:
- fuel_system_integrity
clause_path: f-3
comparison_key: bdede72c930478dbb871193deb58582da0e51f03
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-307-f-3
...
phase: cross_phase
primary_topic: f-a-leak-shall-be-simulated-using-the-remote-controllable-function
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-307 / f-3
source_collection: xml_fmvss
source_url: null
statement: (f) A leak shall be simulated using the remote controllable function.
status: draft
subject: null
summary: Regulation unit `f-3` from xml_fmvss-571-307.
title: (f) A leak shall be simulated using the remote controllable function.
updated: '2026-04-13'
---
