...
basis: '1.2.4.
  ...
  due to the change of angle function, then test for the condition which creates

  the slackest installation, conduct the set-up and tension in the tightest position

  and then reposition the child restraint to the worst case without re-tensioning

  the adult belt. Conduct the dynamic test.'
browse_buckets:
- child_restraints
clause_path: annex-21-1-2-4
comparison_key: 742b93c19c377e3aee042b7c0261f52a701bdc0e
confidence: medium
created: '2026-04-13'
...
id: regunit-pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english-annex-21-1-2-4
...
status: draft
subject: null
summary: Regulation unit `annex-21-1-2-4` from pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english.
title: 1.2.4.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english / annex-21-1-2-4
- source_url: n/a
- confidence: medium
