...
basis: '4.5.1.
  ...
  This test is required only if, on the vehicle-type in question, the friction brakes
  are used

  for the Type-II test.'
browse_buckets: []
clause_path: annex-15-4-5-1
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-15-4-5-1
...
status: draft
subject: null
summary: Regulation unit `annex-15-4-5-1` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 4.5.1.
updated: '2026-04-13'
---
...
## Basis
4.5.1.
This test is required only if, on the vehicle-type in question, the friction brakes are used
for the Type-II test.

## Authority
- clause_path: annex-15-4-5-1
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-15-4-5-1
- source_url: n/a
- confidence: medium
