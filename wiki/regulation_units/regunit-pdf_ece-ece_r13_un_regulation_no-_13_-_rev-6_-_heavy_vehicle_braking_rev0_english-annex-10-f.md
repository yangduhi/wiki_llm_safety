...
basis: '(f)
  ...
  When an additional power supply is available it shall be possible to verify

  the operation of the braking system from this power source.'
browse_buckets: []
clause_path: annex-10-f
comparison_key: f2be141a3f0b2addd7e34ba42d8b62150d3fd149
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-10-f
...
status: draft
subject: null
summary: Regulation unit `annex-10-f` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: (f)
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-10-f
- source_url: n/a
- confidence: medium
