...
basis: (2) 100 ohms/volt for an AC high voltage source if it is conductively connected
  to a DC high voltage source, but only if the AC high voltage source meets the physical
  barrier protection requirements specified in S5.3(c)(1) and S5.3(c)(2); or
browse_buckets: []
clause_path: '2'
comparison_key: 0e5d59311b62480c92ccc1547c3cb4eb8c3493d9
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305-2
...
sectno: null
source_citation: xml_fmvss-571-305 / 2
source_collection: xml_fmvss
source_url: null
statement: (2) 100 ohms/volt for an AC high voltage source if it is conductively connected
  to a DC high voltage source, but only if the AC high voltage source meets the physical
  barrier protection requirements specified in S5.3(c)(1) and S5.3(c)(2); or
status: draft
subject: null
summary: Regulation unit `2` from xml_fmvss-571-305.
title: (2) 100 ohms/volt for an AC high voltage source if it is conductively connected
  to a DC high voltage source, but only if
updated: '2026-04-13'
---

# (2) 100 ohms/volt for an AC high voltage source if it is conductively connected to a DC high voltage source, but only if
