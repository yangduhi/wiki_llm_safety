...
basis: '3.4.3.
  ...
  The manufacturer shall provide the technical authorities with an explanation of

  the design provisions built into "the system" so as to generate safe operation

  under fault conditions. Possible design provisions for failure in "the system" are

  for example:'
browse_buckets: []
clause_path: annex-18-3-4-3
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-18-3-4-3
...
status: draft
subject: null
summary: Regulation unit `annex-18-3-4-3` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.4.3.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-18-3-4-3
- source_url: n/a
- confidence: medium
