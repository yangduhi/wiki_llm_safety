...
basis: (b) Each individual test object (A, B, and C) shall not be less than 3 minutes
  of arc.
browse_buckets: []
clause_path: b-4
comparison_key: 4327689836b15430fdf8a5bd469cc767d8e35628
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-111-b-4
...
- visibility
sectno: null
source_citation: xml_fmvss-571-111 / b-4
source_collection: xml_fmvss
source_url: null
statement: (b) Each individual test object (A, B, and C) shall not be less than 3
  minutes of arc.
status: draft
subject: null
summary: Regulation unit `b-4` from xml_fmvss-571-111.
title: (b) Each individual test object (A, B, and C) shall not be less than 3 minutes
  of arc.
updated: '2026-04-13'
---
