...
basis: (b) For purposes of complying with S8.3, a manufacturer may count a vehicle
  if it—
browse_buckets:
- anti_ejection
clause_path: b-15
comparison_key: f38a4b7f92d3e3851b0efb84e2bc6a4d860a4da4
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-226-b-15
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-226 / b-15
source_collection: xml_fmvss
source_url: null
statement: (b) For purposes of complying with S8.3, a manufacturer may count a vehicle
  if it—
status: draft
subject: null
summary: Regulation unit `b-15` from xml_fmvss-571-226.
title: (b) For purposes of complying with S8.3, a manufacturer may count a vehicle
  if it—
updated: '2026-04-13'
---
