...
basis: '(g) For any tested door edge that contains more than one latch/striker, the
  following setup procedures are used:'
browse_buckets:
- door_retention
clause_path: g
comparison_key: dbbb336fc7d7e13e96eec47fbe699119e10b0db1
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-206-g
...
- doors
sectno: null
source_citation: xml_fmvss-571-206 / g
source_collection: xml_fmvss
source_url: null
statement: '(g) For any tested door edge that contains more than one latch/striker,
  the following setup procedures are used:'
status: draft
subject: null
summary: Regulation unit `g` from xml_fmvss-571-206.
title: '(g) For any tested door edge that contains more than one latch/striker, the
  following setup procedures are used:'
updated: '2026-04-13'
---
