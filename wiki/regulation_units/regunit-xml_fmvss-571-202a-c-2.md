...
basis: (c) Warn that all head restraints must be reinstalled to properly protect vehicle
  occupants.
browse_buckets:
- occupant_restraints
- head_impact
clause_path: c-2
comparison_key: 4bbe26304a667cc6271869f9c0b022216bddc1d2
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-202a-c-2
...
phase: cross_phase
primary_topic: c-warn-that-all-head-restraints-must-be-reinstalled-to-properly-protect-vehicle-
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-202a / c-2
source_collection: xml_fmvss
source_url: null
statement: (c) Warn that all head restraints must be reinstalled to properly protect
  vehicle occupants.
status: draft
subject: null
summary: Regulation unit `c-2` from xml_fmvss-571-202a.
title: (c) Warn that all head restraints must be reinstalled to properly protect vehicle
  occupants.
updated: '2026-04-13'
---
