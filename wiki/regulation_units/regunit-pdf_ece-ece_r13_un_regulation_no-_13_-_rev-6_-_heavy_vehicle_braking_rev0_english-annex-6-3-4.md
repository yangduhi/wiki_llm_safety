...
basis: '3.4.
  ...
  The simulator for checking the response to signals transmitted via the electric
  control

  line shall have the following characteristics:'
browse_buckets: []
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-6-3-4
...
status: draft
subject: null
summary: Regulation unit `annex-6-3-4` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 3.4.
updated: '2026-04-13'
---
...
## Basis
3.4.
The simulator for checking the response to signals transmitted via the electric control
line shall have the following characteristics:

## Authority
- clause_path: annex-6-3-4
- source_file: raw/collections/pdf_ece/ECE_R13_UN_Regulation_No._13_-_Rev.6_-_Heavy_vehicle_braking_Rev0_English.pdf
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-6-3-4
- source_url: n/a
- confidence: medium
