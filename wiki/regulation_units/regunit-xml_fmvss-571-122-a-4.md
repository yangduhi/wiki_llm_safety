...
basis: (a) Two separate service brake systems, except CBS, which, when applied together,
  operate the brakes on all wheels; or
browse_buckets: []
clause_path: a-4
comparison_key: d632d3e5f050a1e43bdc24e6809ad4d9b11e32f5
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-122-a-4
...
phase: cross_phase
primary_topic: a-two-separate-service-brake-systems-except-cbs-which-when-applied-together-oper
provenance:
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-122 / a-4
source_collection: xml_fmvss
source_url: null
statement: (a) Two separate service brake systems, except CBS, which, when applied
  together, operate the brakes on all wheels; or
status: draft
subject: null
summary: Regulation unit `a-4` from xml_fmvss-571-122.
title: (a) Two separate service brake systems, except CBS, which, when applied together,
  operate the brakes on all wheels; or
updated: '2026-04-13'
---
