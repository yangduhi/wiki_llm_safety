...
basis: S7.3.1 Test method to evaluate protection from direct contact with high voltage
  sources. (a) Any parts surrounding the high voltage components are opened, disassembled,
  or removed without the use of tools.
browse_buckets: []
clause_path: s7-3-1
comparison_key: ef71b0f18887de76d725abf04d6660d6c65d6664
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-305a-s7-3-1
...
- high_voltage
sectno: null
source_citation: xml_fmvss-571-305a / s7-3-1
source_collection: xml_fmvss
source_url: null
statement: S7.3.1 Test method to evaluate protection from direct contact with high
  voltage sources. (a) Any parts surrounding the high voltage components are opened,
  disassembled, or removed without the use of tools.
status: draft
subject: null
summary: Regulation unit `s7-3-1` from xml_fmvss-571-305a.
title: S7.3.1 Test method to evaluate protection from direct contact with high voltage
  sources. (a) Any parts surrounding the h
updated: '2026-04-13'
---

# S7.3.1 Test method to evaluate protection from direct contact with high voltage sources. (a) Any parts surrounding the h
