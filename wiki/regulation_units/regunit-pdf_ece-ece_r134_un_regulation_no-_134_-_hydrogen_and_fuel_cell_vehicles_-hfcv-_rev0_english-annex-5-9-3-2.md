...
basis: '9.3.2.
  ...
  In any case, for each batch, which is not permitted to exceed 200 finished

  cylinders or liners (not including destructive test cylinders or liners), or one

  shift of successive production, whichever is greater, at least one container

  shall be subjected to the rupture test in paragraph 9.3.2.1. and furthermore at

  least one container shall be subjected to the pressure cycle test in

  paragraph 9.3.2.2.'
browse_buckets:
- fuel_system_integrity
clause_path: annex-5-9-3-2
comparison_key: 2244bfdfec808b1a50000e930c38f1826f94dbcc
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english-annex-5-9-3-2
...
status: draft
subject: null
summary: Regulation unit `annex-5-9-3-2` from pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english.
title: 9.3.2.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r134_un_regulation_no-_134_-_hydrogen_and_fuel_cell_vehicles_-hfcv-_rev0_english / annex-5-9-3-2
- source_url: n/a
- confidence: medium
