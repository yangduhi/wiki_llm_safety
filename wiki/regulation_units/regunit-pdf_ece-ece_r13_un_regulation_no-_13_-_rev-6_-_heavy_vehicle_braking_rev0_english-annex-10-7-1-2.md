...
basis: '7.1.
  ...
  Vehicles which meet the requirements of this annex by means of a device

  mechanically controlled by the suspension of the vehicle, shall be marked to show

  the useful travel of the device between the positions corresponding to vehicle

  unladen and laden states, respectively, and any further information to enable the

  setting of the device to be checked.'
browse_buckets: []
clause_path: annex-10-7-1-2
comparison_key: 5ef97ca2dfce3e1287f9cf064db92e463c3fe3b9
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english-annex-10-7-1-2
...
status: draft
subject: null
summary: Regulation unit `annex-10-7-1-2` from pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english.
title: 7.1.
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r13_un_regulation_no-_13_-_rev-6_-_heavy_vehicle_braking_rev0_english / annex-10-7-1-2
- source_url: n/a
- confidence: medium
