...
basis: '(2) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. Send your name, address, email address
  if available (preceding four words are optional), and the restraint''s model number
  and manufacturing date to ( insert address ) or call (insert U.S. telephone number)
  or register online at ( insert website for electronic registration form ). For recall
  information, call the U.S. Government''s Vehicle Safety Hotline at 1-888-327-4236
  (TTY: 1-800-424-9153), or go to www.NHTSA.gov. ”'
browse_buckets: []
clause_path: 2-17
comparison_key: 9ac5d53f3ad302be12df382ff779bfd87e30d669
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-213-2-17
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-213 / 2-17
source_collection: xml_fmvss
source_url: null
statement: '(2) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. Send your name, address, email address
  if available (preceding four words are optional), and the restraint''s model number
  and manufacturing date to ( insert address ) or call (insert U.S. telephone number)
  or register online at ( insert website for electronic registration form ). For recall
...
status: draft
subject: null
summary: Regulation unit `2-17` from xml_fmvss-571-213.
title: '(2) “Child restraints could be recalled for safety reasons. You must register
  this restraint to be reached in a recall. '
updated: '2026-04-13'
---

# (2) “Child restraints could be recalled for safety reasons. You must register this restraint to be reached in a recall. 
