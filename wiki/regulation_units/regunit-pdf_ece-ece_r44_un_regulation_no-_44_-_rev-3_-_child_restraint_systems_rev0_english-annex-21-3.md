...
basis: '3.
  ...
  Load cells fitted directly onto the belt webbing may be disconnected

  electrically, but shall be left in place during the dynamic test. The mass of

  each cell is not to exceed 250 grams. Alternatively the lap belt webbing load

  cell may be replaced by a load cell fixed at the anchorage point.'
browse_buckets:
- child_restraints
clause_path: annex-21-3
...
id: regunit-pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english-annex-21-3
...
status: draft
subject: null
summary: Regulation unit `annex-21-3` from pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english.
title: '3.'
updated: '2026-04-13'
---
...
- source_citation: pdf_ece-ece_r44_un_regulation_no-_44_-_rev-3_-_child_restraint_systems_rev0_english / annex-21-3
- source_url: n/a
- confidence: medium
