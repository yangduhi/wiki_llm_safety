...
basis: '(2) W = (F × P)/2
  ...
  Where: W = Breaking energy in inch-pounds (in-lb), F = Force in pounds (lb), and
  P = Penetration in inches (in).'
browse_buckets: []
clause_path: '2'
comparison_key: c7df61f794e0beb6c621ef27a204b0dd14edbbca
confidence: medium
created: '2026-04-13'
...
functional_domain:
- other_or_review
id: regunit-xml_fmvss-571-119-2
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-119 / 2
source_collection: xml_fmvss
source_url: null
statement: (2) W = (F × P)/2
status: draft
subject: null
summary: Regulation unit `2` from xml_fmvss-571-119.
title: (2) W = (F × P)/2
updated: '2026-04-13'
---
...
## Basis
(2) W = (F × P)/2
Where: W = Breaking energy in inch-pounds (in-lb), F = Force in pounds (lb), and P = Penetration in inches (in).
