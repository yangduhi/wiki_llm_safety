...
basis: (c) For purposes of complying with S8.4, a manufacturer may count a vehicle
  if it—
browse_buckets:
- anti_ejection
clause_path: c-7
comparison_key: c55f62b5189f68274ed1ab12de5e67fa938f112b
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-226-c-7
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-226 / c-7
source_collection: xml_fmvss
source_url: null
statement: (c) For purposes of complying with S8.4, a manufacturer may count a vehicle
  if it—
status: draft
subject: null
summary: Regulation unit `c-7` from xml_fmvss-571-226.
title: (c) For purposes of complying with S8.4, a manufacturer may count a vehicle
  if it—
updated: '2026-04-13'
---
