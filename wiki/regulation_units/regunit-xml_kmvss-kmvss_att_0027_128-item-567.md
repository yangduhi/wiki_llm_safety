...
basis: 가) 운전자가 자동차로유지기능을 해제하는 경우
browse_buckets: []
clause_path: item-567
comparison_key: aa65c2817c5377e130a769c12e398ac38130ad9f
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_kmvss-kmvss_att_0027_128-item-567
...
line_index_end: 567
line_index_start: 567
note_type: regulation_unit
page_end: null
page_start: null
parent_clause_path: 5-565
parent_clause_text: 5) 다음의 어느 하나에 해당하는 경우에만 운전전환요구를 중지할 것
parent_title: 가) 운전자가 자동차로유지기능을 해제하는 경우
phase: pre_crash
...
- automated_driving
sectno: 별표 0027
source_citation: xml_kmvss-kmvss_att_0027_128 / item-567
source_collection: xml_kmvss
source_url: null
statement: 가) 운전자가 자동차로유지기능을 해제하는 경우
status: draft
subject: 부분 자율주행시스템의 안전기준(제111조의3 관련)
summary: Regulation unit `item-567` from xml_kmvss-kmvss_att_0027_128.
title: 가) 운전자가 자동차로유지기능을 해제하는 경우
updated: '2026-04-13'
---

# 가) 운전자가 자동차로유지기능을 해제하는 경우
