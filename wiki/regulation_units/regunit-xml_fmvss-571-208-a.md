...
basis: (a) At each designated seating position have a Type 1 seatbelt assembly or
  a Type 2 seatbelt assembly with a detachable upper torso portion that conforms to
  S7.1 and S7.2 of this standard;
browse_buckets:
- occupant_restraints
- seat_systems
clause_path: a
comparison_key: 66a80f80570be17dc8b3090def637a00384926ed
confidence: medium
created: '2026-04-13'
...
id: regunit-xml_fmvss-571-208-a
...
secondary_topics: []
sectno: null
source_citation: xml_fmvss-571-208 / a
source_collection: xml_fmvss
source_url: null
statement: (a) At each designated seating position have a Type 1 seatbelt assembly
  or a Type 2 seatbelt assembly with a detachable upper torso portion that conforms
  to S7.1 and S7.2 of this standard;
status: draft
subject: null
summary: Regulation unit `a` from xml_fmvss-571-208.
title: '(a) At each designated seating position have a Type 1 seatbelt assembly or
  a Type 2 seatbelt assembly with a detachable '
updated: '2026-04-13'
---

# (a) At each designated seating position have a Type 1 seatbelt assembly or a Type 2 seatbelt assembly with a detachable 
